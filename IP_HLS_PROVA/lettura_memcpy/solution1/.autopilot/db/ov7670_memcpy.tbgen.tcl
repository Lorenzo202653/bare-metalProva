set C_TypeInfoList {{ 
"ov7670_memcpy" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"data_in": [["volatile"],"0"] }, {"href": [[],"1"] }, {"vsync": [[],"1"] }, {"data_out": [[],{ "pointer": "0"}] }, {"line_valid": [[],{ "pointer": "2"}] }, {"frame_valid": [[],{ "pointer": "2"}] }],[],""], 
"0": [ "uint8_t", {"typedef": [[[], {"scalar": "unsigned char"}],""]}], 
"1": [ "bit", {"typedef": [[[],"3"],""]}], 
"3": [ "ap_uint<1>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 1}}]],""]}}], 
"2": [ "bit", {"typedef": [[[],"3"],""]}]
}}
set moduleName ov7670_memcpy
...
set C_modelArgList {
	...
	{ data_out int 32 regular {axi_slave 0}  }
	{ line_valid_V int 1 regular {pointer 1 volatile }  }
	{ frame_valid_V int 1 regular {pointer 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "data_out","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"offset": { "type": "dynamic","port_name": "data_out","bundle": "AXILiteS"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "data_out", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
...
set portList { 
	...
	{ data_in sc_in sc_lv 8 signal 1 } 
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"ov7670_memcpy","role":"start","value":"0","valid_bit":"0"},{"name":"ov7670_memcpy","role":"continue","value":"0","valid_bit":"4"},{"name":"ov7670_memcpy","role":"auto_start","value":"0","valid_bit":"7"},{"name":"data_out","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_AXILiteS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "ARADDR" },"address":[{"name":"ov7670_memcpy","role":"start","value":"0","valid_bit":"0"},{"name":"ov7670_memcpy","role":"done","value":"0","valid_bit":"1"},{"name":"ov7670_memcpy","role":"idle","value":"0","valid_bit":"2"},{"name":"ov7670_memcpy","role":"ready","value":"0","valid_bit":"3"},{"name":"ov7670_memcpy","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ov7670_memcpy_AXILiteS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ov7670_memcpy_gmem_m_axi_U", "Parent" : "0"}]}
