set C_TypeInfoList {{ 
"ov7670_buffer" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"inStream": [[], {"reference": "0"}] }, {"outStream_grayscale": [[],{ "pointer": "1"}] }, {"enable_raw_stream": [[], {"scalar": "bool"}] }, {"outStream_LUMA": [[], {"reference": "0"}] }, {"outStream_CHROMA": [[], {"reference": "0"}] }],[],""], 
"1": [ "byte", {"typedef": [[[],"2"],""]}], 
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "outStream_grayscale.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"offset": { "type": "dynamic","port_name": "outStream_grayscale_V","bundle": "AXILiteS"},"cArray": [{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ov7670_buffer_AXILiteS_s_axi_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	ov7670_buffer {
		...
		outStream_grayscale_V {Type I LastRead -1 FirstWrite -1}
		enable_raw_stream {Type I LastRead 1 FirstWrite -1}
		outStream_LUMA_V_V {Type O LastRead -1 FirstWrite 1}
