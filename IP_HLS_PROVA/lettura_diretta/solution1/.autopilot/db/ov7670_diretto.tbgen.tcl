set C_TypeInfoList {{ 
"ov7670_diretto" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"data_in": [["volatile"],"0"] }, {"href": [[],"1"] }, {"vsync": [[],"1"] }, {"data_out": [[], {"reference": "2"}] }, {"line_valid": [[],{ "pointer": "3"}] }, {"frame_valid": [[],{ "pointer": "3"}] }],[],""], 
"0": [ "uint8_t", {"typedef": [[[], {"scalar": "unsigned char"}],""]}], 
"1": [ "bit", {"typedef": [[[],"4"],""]}], 
"4": [ "ap_uint<1>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 1}}]],""]}}], 
"2": [ "stream<unsigned char>", {"hls_type": {"stream": [[[[], {"scalar": "unsigned char"}]],"5"]}}], 
"3": [ "bit", {"typedef": [[[],"4"],""]}],
"5": ["hls", ""]
}}
...
set C_modelArgList {
	...
	{ data_out_V int 8 regular {axi_s 1 volatile  { data_out_V Data } }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "data_in", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "data_in","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "data_out_V", "interface" : "axis", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "data_out.V","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ data_out_V_TDATA sc_out sc_lv 8 signal 3 } 
	{ data_out_V_TVALID sc_out sc_logic 1 outvld 3 } 
	{ data_out_V_TREADY sc_in sc_logic 1 outacc 3 } 
...
set NewPortList {[ 
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "AXILiteS", "role": "interrupt" } }, 
 	...
 	{ "name": "data_out_V_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "data_out_V", "role": "TDATA" }} , 
...
set Spec2ImplPortList { 
	...
	data_out_V { axis {  { data_out_V_TDATA out_data 1 8 }  { data_out_V_TVALID out_vld 1 1 }  { data_out_V_TREADY out_acc 0 1 } } }
