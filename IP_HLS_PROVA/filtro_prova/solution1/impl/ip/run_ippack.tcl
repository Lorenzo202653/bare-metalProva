...
set Library     "hls"
set IPName      "ov7670_prova"
set Version     "1.0"
set DisplayName "Ov7670_prova"
set Revision    "2009211136"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 base_address_1 W 0x0 "Data signal of base_address" {{0 32 base_address W 0 "Bit 31 to 0 Data signal of base_address"}}} {0x14 base_address_2 W 0x0 "Data signal of base_address" {{0 32 base_address W 0 "Bit 63 to 32 Data signal of base_address"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS inStream_V_V m_axi_outStream_grayscale_V outStream_LUMA_V_V outStream_CHROMA_V_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_outStream_grayscale_V {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_outStream_grayscale_V"
        data_width "32"
        param_prefix "C_M_AXI_OUTSTREAM_GRAYSCALE_V"
