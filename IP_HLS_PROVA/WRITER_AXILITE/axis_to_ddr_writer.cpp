...
void axis_writer(hls::stream<DATA_IN> &inputStream, volatile u64* base_ddr_addr, volatile ap_uint<FRAME_INDEX_WIDTH>* frame_index, unsigned int* frame_count,
...
#pragma HLS INTERFACE s_axilite port=frame_buffer_number
    ...
    #pragma HLS INTERFACE m_axi depth=32 port=frame_index
