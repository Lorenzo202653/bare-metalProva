; ModuleID = '/media/kidre/Dati/GIT_TEST/IP_HLS_PROVA/axi_prova/solution1/.autopilot/db/a.o.2.bc'
...
@axi_write_prova_str = internal unnamed_addr constant [16 x i8] c"axi_write_prova\00"
...
@p_str8 = private unnamed_addr constant [12 x i8] c"RAM_2P_BRAM\00", align 1
@p_str7 = private unnamed_addr constant [6 x i8] c"slave\00", align 1
@p_str6 = private unnamed_addr constant [12 x i8] c"frame_index\00", align 1
...
codeRepl:
  ...
  %frame_index_V_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %frame_index_V)
  %tmp_3 = sext i32 %frame_index_V_read to i64
  %frame_index_addr = getelementptr i8* %frame_index, i64 %tmp_3
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %frame_index), !map !69
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %inputStream_V), !map !75
  call void (...)* @_ssdm_op_SpecBitsMap(i64* %base_ddr_addr), !map !79
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %frame_count), !map !83
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %base_address), !map !87
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %frame_buffer_dim), !map !93
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %frame_buffer_offset), !map !97
  call void (...)* @_ssdm_op_SpecBitsMap(i8 %frame_buffer_number), !map !101
  call void (...)* @_ssdm_op_SpecBitsMap(i1 %update_intr), !map !105
  ...
  call void (...)* @_ssdm_op_SpecInterface(i8* %frame_index, [6 x i8]* @p_str2, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 32, [12 x i8]* @p_str6, [6 x i8]* @p_str7, [1 x i8]* @p_str1, i32 16, i32 16, i32 16, i32 16, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
  call void (...)* @_ssdm_op_SpecInterface(i32 %frame_index_V, [10 x i8]* @mode, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 32, [1 x i8]* @bundle, [6 x i8]* @p_str7, [1 x i8]* @p_str1, i32 16, i32 16, i32 16, i32 16, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
  call void (...)* @_ssdm_op_SpecMemCore([512 x i64]* %buffer, [1 x i8]* @p_str1, [12 x i8]* @p_str8, [1 x i8]* @p_str1, i32 -1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1)
  call void (...)* @_ssdm_op_SpecReset(i8* @inner_index_V, i32 1, [1 x i8]* @p_str1) nounwind
  %t_V = load i8* @inner_index_V, align 1
  %frame_index_addr_req = call i1 @_ssdm_op_WriteReq.m_axi.i8P(i8* %frame_index_addr, i32 1)
  call void @_ssdm_op_Write.m_axi.volatile.i8P(i8* %frame_index_addr, i8 %t_V, i1 true)
  %frame_index_addr_res = call i1 @_ssdm_op_WriteResp.m_axi.i8P(i8* %frame_index_addr)
...
; <label>:1                                       ; preds = %memcpy.tail, %._crit_edge98
  ...
  %tmp_6 = zext i20 %tmp_s to i32
  %tmp_1 = icmp ult i32 %idx, %tmp_6
...
.preheader95:                                     ; preds = %.preheader
  ...
  %tmp_11 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str9)
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %tmp = call i8 @_ssdm_op_Read.axis.volatile.i8P(i8* %inputStream_V)
  %tmp_12 = call i56 @_ssdm_op_PartSelect.i56.i64.i32.i32(i64 %temp, i32 8, i32 63)
  %temp_1 = select i1 %tmp_4, i56 0, i56 %tmp_12
  %temp_2 = call i64 @_ssdm_op_BitConcatenate.i64.i8.i56(i8 %tmp, i56 %temp_1)
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str9, i32 %tmp_11)
  %i_op = add i4 %i, 1
...
!72 = metadata !{metadata !"frame_index.V", metadata !73, metadata !"uint8", i32 0, i32 7}
!73 = metadata !{metadata !74}
!74 = metadata !{i32 0, i32 31, i32 1}
!75 = metadata !{metadata !76}
!76 = metadata !{i32 0, i32 7, metadata !77}
!77 = metadata !{metadata !78}
!78 = metadata !{metadata !"inputStream.V", metadata !65, metadata !"unsigned char", i32 0, i32 7}
!79 = metadata !{metadata !80}
!80 = metadata !{i32 0, i32 63, metadata !81}
!81 = metadata !{metadata !82}
!82 = metadata !{metadata !"base_ddr_addr", metadata !73, metadata !"long long unsigned int", i32 0, i32 63}
!83 = metadata !{metadata !84}
!84 = metadata !{i32 0, i32 31, metadata !85}
!85 = metadata !{metadata !86}
!86 = metadata !{metadata !"frame_count", metadata !65, metadata !"unsigned int", i32 0, i32 31}
!87 = metadata !{metadata !88}
!88 = metadata !{i32 0, i32 31, metadata !89}
!89 = metadata !{metadata !90}
!90 = metadata !{metadata !"base_address", metadata !91, metadata !"unsigned int", i32 0, i32 31}
!91 = metadata !{metadata !92}
!92 = metadata !{i32 0, i32 0, i32 0}
!93 = metadata !{metadata !94}
!94 = metadata !{i32 0, i32 31, metadata !95}
!95 = metadata !{metadata !96}
!96 = metadata !{metadata !"frame_buffer_dim", metadata !91, metadata !"unsigned int", i32 0, i32 31}
!97 = metadata !{metadata !98}
!98 = metadata !{i32 0, i32 31, metadata !99}
!99 = metadata !{metadata !100}
!100 = metadata !{metadata !"frame_buffer_offset", metadata !91, metadata !"unsigned int", i32 0, i32 31}
!101 = metadata !{metadata !102}
!102 = metadata !{i32 0, i32 7, metadata !103}
!103 = metadata !{metadata !104}
!104 = metadata !{metadata !"frame_buffer_number", metadata !91, metadata !"unsigned char", i32 0, i32 7}
!105 = metadata !{metadata !106}
!106 = metadata !{i32 0, i32 0, metadata !107}
!107 = metadata !{metadata !108}
!108 = metadata !{metadata !"update_intr", metadata !91, metadata !"bool", i32 0, i32 0}
