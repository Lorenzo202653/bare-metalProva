...
set Library     "hls"
set IPName      "axi_write_prova"
set Version     "1.0"
set DisplayName "Axi_write_prova"
set Revision    "2009041211"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 frame_index_V W 0x0 "Data signal of frame_index_V" {{0 32 frame_index_V W 0 "Bit 31 to 0 Data signal of frame_index_V"}}} {0x18 base_address W 0x0 "Data signal of base_address" {{0 32 base_address W 0 "Bit 31 to 0 Data signal of base_address"}}} {0x20 frame_buffer_dim W 0x0 "Data signal of frame_buffer_dim" {{0 32 frame_buffer_dim W 0 "Bit 31 to 0 Data signal of frame_buffer_dim"}}} {0x28 frame_buffer_offset W 0x0 "Data signal of frame_buffer_offset" {{0 32 frame_buffer_offset W 0 "Bit 31 to 0 Data signal of frame_buffer_offset"}}} {0x30 frame_buffer_number W 0x0 "Data signal of frame_buffer_number" {{0 8 frame_buffer_number W 0 "Bit 7 to 0 Data signal of frame_buffer_number"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 update_intr W 0x0 "Data signal of update_intr" {{0 1 update_intr W 0 "Bit 0 to 0 Data signal of update_intr"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_frame_index inputStream_V m_axi_base_ddr_addr"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_frame_index {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_frame_index"
        data_width "32"
        param_prefix "C_M_AXI_FRAME_INDEX"
