...
#include "lettura_diretta.h"
#include "string.h"

// La funzione deve essere attivata ad ogni fronte di salita di pclk
void ov7670_diretto(volatile uint8_t data_in, bit href, bit vsync, volatile uint8_t* data_out, volatile bit *line_valid, volatile bit *frame_valid)
{
