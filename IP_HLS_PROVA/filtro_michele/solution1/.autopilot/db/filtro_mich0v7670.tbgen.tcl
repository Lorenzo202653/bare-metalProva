set C_TypeInfoList {{ 
"filtro_mich0v7670" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"inStream": [[], {"reference": "0"}] }, {"outStream_grayscale": [[],{ "pointer": "1"}] }, {"enable_raw_stream": [[], {"scalar": "bool"}] }, {"outStream_LUMA": [[], {"reference": "0"}] }, {"outStream_CHROMA": [[], {"reference": "0"}] }],[],""], 
"1": [ "byte", {"typedef": [[[],"2"],""]}], 
"2": [ "ap_uint<8>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 8}}]],""]}}], 
"0": [ "stream<ap_uint<8> >", {"hls_type": {"stream": [[[[],"2"]],"3"]}}],
"3": ["hls", ""]
}}
set moduleName filtro_mich0v7670
...
set C_modelName {filtro_mich0v7670}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 8 regular {axi_master 1}  }
	{ inStream_V_V int 8 regular {axi_s 0 volatile  { inStream_V_V Data } }  }
	{ outStream_grayscale_V int 32 regular {axi_slave 0}  }
	{ enable_raw_stream int 1 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "outStream_grayscale.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"offset": { "type": "dynamic","port_name": "outStream_grayscale_V","bundle": "AXILiteS"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "outStream_grayscale_V", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
...
set portList { 
	...
	{ enable_raw_stream sc_in sc_logic 1 signal 3 } 
	{ outStream_LUMA_V_V_TDATA sc_out sc_lv 8 signal 4 } 
	{ outStream_LUMA_V_V_TVALID sc_out sc_logic 1 outvld 4 } 
	{ outStream_LUMA_V_V_TREADY sc_in sc_logic 1 outacc 4 } 
	{ outStream_CHROMA_V_V_TDATA sc_out sc_lv 8 signal 5 } 
	{ outStream_CHROMA_V_V_TVALID sc_out sc_logic 1 outvld 5 } 
	{ outStream_CHROMA_V_V_TREADY sc_in sc_logic 1 outacc 5 } 
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"outStream_grayscale_V","role":"data","value":"16"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "outStream_grayscale_V", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.filtro_mich0v7670_AXILiteS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.filtro_mich0v7670_gmem_m_axi_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	filtro_mich0v7670 {
		...
		outStream_grayscale_V {Type I LastRead 0 FirstWrite -1}
