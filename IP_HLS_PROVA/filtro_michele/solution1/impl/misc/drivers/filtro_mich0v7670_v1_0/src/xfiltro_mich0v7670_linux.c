...
typedef struct {
    ...
    XFiltro_mich0v7670_uio_map maps[ MAX_UIO_MAPS ];
} XFiltro_mich0v7670_uio_info;

/***************** Variable Definitions **************************************/
static XFiltro_mich0v7670_uio_info uio_info;
...
static int uio_info_read_name(XFiltro_mich0v7670_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XFiltro_mich0v7670_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XFiltro_mich0v7670_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XFiltro_mich0v7670_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XFiltro_mich0v7670_Initialize(XFiltro_mich0v7670 *InstancePtr, const char* InstanceName) {
	XFiltro_mich0v7670_uio_info *InfoPtr = &uio_info;
