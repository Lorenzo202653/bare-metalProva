...
architecture behav of filtro_mich0v7670 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "filtro_mich0v7670,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu3eg-sbva484-1-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=6,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=795,HLS_SYN_LUT=1184}";
    ...
    signal enable_raw_stream_re_read_fu_84_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state11 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state11 : signal is "none";
    signal grayscale_valid_load_reg_205 : STD_LOGIC_VECTOR (0 downto 0);
    signal outStream_CHROMA_V_V_TDATA_blk_n : STD_LOGIC;
    signal grayscale_valid_load_load_fu_125_p1 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal outStream_grayscale_2_fu_157_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_5_cast_fu_147_p1 : STD_LOGIC_VECTOR (32 downto 0);
    signal tmp_cast_fu_122_p1 : STD_LOGIC_VECTOR (32 downto 0);
    signal outStream_grayscale_s_fu_151_p2 : STD_LOGIC_VECTOR (32 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (10 downto 0);

    component filtro_mich0v7670_AXILiteS_s_axi IS
    generic (
    ...
    component filtro_mich0v7670_gmem_m_axi IS
    generic (
...
begin
    filtro_mich0v7670_AXILiteS_s_axi_U : component filtro_mich0v7670_AXILiteS_s_axi
    generic map (
    ...
    filtro_mich0v7670_gmem_m_axi_U : component filtro_mich0v7670_gmem_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 8,
        USER_AW => 32,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((not(((inStream_V_V_0_vld_out = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state2_io))) and (ap_const_logic_1 = ap_CS_fsm_state2) and (grayscale_valid_load_load_fu_125_p1 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((inStream_V_V_0_vld_out = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state2_io))) and (ap_const_logic_1 = ap_CS_fsm_state2) and (grayscale_valid_load_load_fu_125_p1 = ap_const_lv1_1))) then
                gmem_addr_reg_210 <= outStream_grayscale_2_fu_157_p1(32 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, inStream_V_V_0_vld_out, outStream_LUMA_V_V_1_ack_in, outStream_CHROMA_V_V_1_ack_in, grayscale_valid, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state10, ap_CS_fsm_state2, ap_CS_fsm_state11, grayscale_valid_load_load_fu_125_p1, ap_CS_fsm_state3, gmem_BVALID, ap_block_state2_io, ap_sig_ioackin_gmem_AWREADY, ap_block_state10_io, ap_sig_ioackin_gmem_WREADY, ap_block_state11_io, ap_block_state3_io)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if ((not(((inStream_V_V_0_vld_out = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state2_io))) and (ap_const_logic_1 = ap_CS_fsm_state2) and (grayscale_valid = ap_const_lv1_0))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                elsif ((not(((inStream_V_V_0_vld_out = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state2_io))) and (ap_const_logic_1 = ap_CS_fsm_state2) and (grayscale_valid_load_load_fu_125_p1 = ap_const_lv1_1))) then
            ...
            when ap_ST_fsm_state5 => 
                if (((ap_sig_ioackin_gmem_WREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then
            ...
            when ap_ST_fsm_state10 => 
                if ((not(((gmem_BVALID = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state10_io))) and (ap_const_logic_1 = ap_CS_fsm_state10))) then
                    ap_NS_fsm <= ap_ST_fsm_state11;
                else
                    ap_NS_fsm <= ap_ST_fsm_state10;
                end if;
    ...
    ap_block_state10_io_assign_proc : process(outStream_LUMA_V_V_1_ack_in, enable_raw_stream_re_read_fu_84_p2)
    begin
                ap_block_state10_io <= ((outStream_LUMA_V_V_1_ack_in = ap_const_logic_0) and (enable_raw_stream_re_read_fu_84_p2 = ap_const_lv1_1));
    end process;
    ...
    ap_block_state3_io_assign_proc : process(outStream_CHROMA_V_V_1_ack_in, enable_raw_stream_re_read_fu_84_p2)
    begin
                ap_block_state3_io <= ((outStream_CHROMA_V_V_1_ack_in = ap_const_logic_0) and (enable_raw_stream_re_read_fu_84_p2 = ap_const_lv1_1));
    end process;
    ...
    ap_predicate_op35_write_state2_assign_proc : process(grayscale_valid, enable_raw_stream_re_read_fu_84_p2)
    begin
                ap_predicate_op35_write_state2 <= ((enable_raw_stream_re_read_fu_84_p2 = ap_const_lv1_1) and (grayscale_valid = ap_const_lv1_0));
    end process;


    ap_predicate_op57_write_state11_assign_proc : process(enable_raw_stream_re_read_fu_84_p2, grayscale_valid_load_reg_205)
    begin
                ap_predicate_op57_write_state11 <= ((grayscale_valid_load_reg_205 = ap_const_lv1_1) and (enable_raw_stream_re_read_fu_84_p2 = ap_const_lv1_1));
    end process;
    ...
    enable_raw_stream_re_read_fu_84_p2 <= (0=>enable_raw_stream, others=>'-');
    ...
    gmem_BREADY_assign_proc : process(ap_CS_fsm_state10, gmem_BVALID, ap_block_state10_io)
    begin
        if ((not(((gmem_BVALID = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state10_io))) and (ap_const_logic_1 = ap_CS_fsm_state10))) then 
    ...
    gmem_WVALID_assign_proc : process(ap_CS_fsm_state5, ap_reg_ioackin_gmem_WREADY)
    begin
        if (((ap_reg_ioackin_gmem_WREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
    ...
    grayscale_valid_load_load_fu_125_p1 <= grayscale_valid;
    ...
    offset_fu_139_p3 <= 
        ap_const_lv32_0 when (tmp_3_fu_133_p2(0) = '1') else 
        inner_index_V;
    ...
    outStream_CHROMA_V_V_TDATA_blk_n_assign_proc : process(outStream_CHROMA_V_V_1_state, grayscale_valid, ap_CS_fsm_state2, enable_raw_stream_re_read_fu_84_p2, ap_CS_fsm_state3)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state3) and (enable_raw_stream_re_read_fu_84_p2 = ap_const_lv1_1)) or ((ap_const_logic_1 = ap_CS_fsm_state2) and (enable_raw_stream_re_read_fu_84_p2 = ap_const_lv1_1) and (grayscale_valid = ap_const_lv1_0)))) then 
    ...
    outStream_LUMA_V_V_1_vld_in_assign_proc : process(ap_CS_fsm_state10, enable_raw_stream_re_read_fu_84_p2, gmem_BVALID, ap_block_state10_io)
    begin
        if ((not(((gmem_BVALID = ap_const_logic_0) or (ap_const_boolean_1 = ap_block_state10_io))) and (ap_const_logic_1 = ap_CS_fsm_state10) and (enable_raw_stream_re_read_fu_84_p2 = ap_const_lv1_1))) then 
    ...
    outStream_LUMA_V_V_TDATA_blk_n_assign_proc : process(outStream_LUMA_V_V_1_state, ap_CS_fsm_state10, enable_raw_stream_re_read_fu_84_p2, ap_CS_fsm_state11, grayscale_valid_load_reg_205)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state11) and (grayscale_valid_load_reg_205 = ap_const_lv1_1) and (enable_raw_stream_re_read_fu_84_p2 = ap_const_lv1_1)) or ((ap_const_logic_1 = ap_CS_fsm_state10) and (enable_raw_stream_re_read_fu_84_p2 = ap_const_lv1_1)))) then 
    ...
    outStream_LUMA_V_V_TVALID <= outStream_LUMA_V_V_1_state(0);
        outStream_grayscale_2_fu_157_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(outStream_grayscale_s_fu_151_p2),64));

    outStream_grayscale_s_fu_151_p2 <= std_logic_vector(signed(tmp_5_cast_fu_147_p1) + signed(tmp_cast_fu_122_p1));
    tmp_3_fu_133_p2 <= "1" when (inner_index_V = ap_const_lv32_4B000) else "0";
        tmp_5_cast_fu_147_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(offset_fu_139_p3),33));

    tmp_6_fu_167_p2 <= std_logic_vector(signed(offset_fu_139_p3) + signed(ap_const_lv32_1));
    tmp_9_fu_179_p2 <= (grayscale_valid_load_reg_205 xor ap_const_lv1_1);
        tmp_cast_fu_122_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(outStream_grayscale_1_reg_190),33));
