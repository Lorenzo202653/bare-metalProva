; ModuleID = '/home/kidre/Documenti/Università/Uni/Tesi/SmartCamera/HLS_COMMON/FILTERS/Configurable_Convolution_Filter/solution1/.autopilot/db/a.o.2.bc'
...
@convolution_filter_s = internal unnamed_addr constant [19 x i8] c"convolution_filter\00"
...
@p_str4 = private unnamed_addr constant [29 x i8] c"?Mul_LUT_temp_Region_1890563\00", align 1
@p_str11 = private unnamed_addr constant [9 x i8] c"Loop_col\00", align 1
...
codeRepl1:
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([51 x i8]* %kernel_config_V), !map !74
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %in_img_V), !map !80
  call void (...)* @_ssdm_op_SpecBitsMap(i8* %out_img_V), !map !86
  call void (...)* @_ssdm_op_SpecTopModule([19 x i8]* @convolution_filter_s) nounwind
  ...
  call void (...)* @_ssdm_op_SpecInterface([51 x i8]* %kernel_config_V, [10 x i8]* @p_str6, i32 0, i32 0, [1 x i8]* @p_str, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str) nounwind
  call void (...)* @_ssdm_op_SpecInterface(i8* %out_img_V, [5 x i8]* @p_str7, i32 1, i32 1, [5 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str)
  call void (...)* @_ssdm_op_SpecInterface(i8* %in_img_V, [5 x i8]* @p_str7, i32 1, i32 1, [5 x i8]* @p_str8, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str)
...
; <label>:0                                       ; preds = %codeRepl1, %._crit_edge66
  %indvar_flatten = phi i19 [ 0, %codeRepl1 ], [ %indvar_flatten_next, %._crit_edge66 ]
  %iteration = phi i19 [ 0, %codeRepl1 ], [ %iteration_mid2, %._crit_edge66 ]
  %row = phi i9 [ 0, %codeRepl1 ], [ %row_mid2, %._crit_edge66 ]
  %iteration_1 = phi i19 [ 0, %codeRepl1 ], [ %tmp_36, %._crit_edge66 ]
  %col = phi i10 [ 0, %codeRepl1 ], [ %col_1, %._crit_edge66 ]
  %in_temp_V_1_load = load i8* %in_temp_V_1
  %window_V_5_6_loc_1_l = load i8* %window_V_5_6_loc_1
  %window_V_4_6_loc_1_l = load i8* %window_V_4_6_loc_1
  %window_V_3_6_loc_1_l = load i8* %window_V_3_6_loc_1
  %window_V_2_6_loc_1_l = load i8* %window_V_2_6_loc_1
  %window_V_1_6_loc_1_l = load i8* %window_V_1_6_loc_1
  %window_V_0_6_loc_1_l = load i8* %window_V_0_6_loc_1
...
._crit_edge63:                                    ; preds = %.reset
  ...
  %tmp_9 = icmp sgt i32 %j_1_load, 6
  %tmp_7 = add nsw i32 1, %i_1_load
  %p_j_1 = select i1 %tmp_9, i32 0, i32 %j_1_load
  %tmp_7_i_1 = select i1 %tmp_9, i32 %tmp_7, i32 %i_1_load
  %tmp_2 = zext i19 %iteration_1_mid2 to i64
  %kernel_config_V_addr_2 = getelementptr [51 x i8]* %kernel_config_V, i64 0, i64 %tmp_2
  %kernel_config_V_load = load i8* %kernel_config_V_addr_2, align 1
  %tmp_65 = trunc i32 %tmp_7_i_1 to i3
  %tmp_66 = trunc i32 %p_j_1 to i3
  switch i3 %tmp_65, label %branch6 [
    i3 0, label %branch0
    i3 1, label %branch1
    i3 2, label %branch2
    i3 3, label %branch3
...
._crit_edge6376:                                  ; preds = %branch6138, %branch5129, %branch4120, %branch3111, %branch2102, %branch193, %branch084
  %tmp_10 = add nsw i32 %p_j_1, 1
  store i32 %tmp_10, i32* %j_1
  store i32 %tmp_7_i_1, i32* %i_1
  br label %.preheader45.preheader.0

; <label>:1                                       ; preds = %.reset
  %tmp_s = icmp eq i19 %iteration_1_mid2, 49
...
; <label>:3                                       ; preds = %1
  %tmp_3 = icmp eq i19 %iteration_1_mid2, 50
  br i1 %tmp_3, label %4, label %._crit_edge64
...
.preheader45.preheader.0:                         ; preds = %5, %._crit_edge6376
  ...
  store i8 %window_V_0_6_loc_1_l, i8* @window_V_0_5, align 1
  ...
  store i8 %window_V_1_6_loc_1_l, i8* @window_V_1_5, align 1
  ...
  store i8 %window_V_2_6_loc_1_l, i8* @window_V_2_5, align 1
  ...
  store i8 %window_V_3_6_loc_1_l, i8* @window_V_3_5, align 1
  ...
  store i8 %window_V_4_6_loc_1_l, i8* @window_V_4_5, align 1
  ...
  store i8 %window_V_5_6_loc_1_l, i8* @window_V_5_5, align 1
  ...
  %tmp_11 = icmp ult i10 %col_mid2, -384
  br i1 %tmp_11, label %.preheader.preheader, label %.loopexit

.preheader.preheader:                             ; preds = %.preheader45.preheader.0
  %tmp_12 = zext i10 %col_mid2 to i64
  %line_buffer_V_0_addr = getelementptr [640 x i8]* @line_buffer_V_0, i64 0, i64 %tmp_12
  %line_buffer_V_0_load = load i8* %line_buffer_V_0_addr, align 1
  store i8 %line_buffer_V_0_load, i8* @window_V_0_6, align 2
  %line_buffer_V_1_addr = getelementptr [640 x i8]* @line_buffer_V_1, i64 0, i64 %tmp_12
  ...
  %line_buffer_V_2_addr = getelementptr [640 x i8]* @line_buffer_V_2, i64 0, i64 %tmp_12
  ...
  %line_buffer_V_3_addr = getelementptr [640 x i8]* @line_buffer_V_3, i64 0, i64 %tmp_12
  ...
  %line_buffer_V_4_addr = getelementptr [640 x i8]* @line_buffer_V_4, i64 0, i64 %tmp_12
  ...
  %line_buffer_V_5_addr = getelementptr [640 x i8]* @line_buffer_V_5, i64 0, i64 %tmp_12
...
.loopexit:                                        ; preds = %.preheader.preheader, %.preheader45.preheader.0
  %or_cond = and i1 %tmp_11, %tmp_4_mid2
...
; <label>:6                                       ; preds = %.loopexit
  ...
  %tmp_13 = zext i10 %col_mid2 to i64
  %line_buffer_V_5_addr_1 = getelementptr [640 x i8]* @line_buffer_V_5, i64 0, i64 %tmp_13
...
.loopexit._crit_edge:                             ; preds = %6, %.loopexit
  %tmp_14 = icmp ugt i10 %col_mid2, 2
  %or_cond1 = and i1 %tmp_6_mid2, %tmp_14
...
pixel_weighted_average.exit:                      ; preds = %.loopexit._crit_edge
  ...
  %window_V_5_6_loc_1_l_1 = load i8* %window_V_5_6_loc_1
  %window_V_4_6_loc_1_l_1 = load i8* %window_V_4_6_loc_1
  %window_V_3_6_loc_1_l_1 = load i8* %window_V_3_6_loc_1
  %window_V_2_6_loc_1_l_1 = load i8* %window_V_2_6_loc_1
  %window_V_1_6_loc_1_l_1 = load i8* %window_V_1_6_loc_1
  %window_V_0_6_loc_1_l_1 = load i8* %window_V_0_6_loc_1
  ...
  %empty_3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_15)
  %tmp_381_cast = sext i16 %r_V_s to i18
  ...
  %empty_4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_16)
  %tmp_38_0_1_cast = sext i16 %r_V_2_0_1 to i17
  ...
  %empty_5 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_17)
  %tmp_38_0_2_cast = sext i16 %r_V_2_0_2 to i17
  ...
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_18)
  %tmp_38_0_3_cast = sext i16 %r_V_2_0_3 to i18
  ...
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_19)
  %tmp_38_0_4_cast = sext i16 %r_V_2_0_4 to i17
  %tmp_20 = call i32 (...)* @_ssdm_op_SpecRegionBegin([29 x i8]* @p_str4)
  %lhs_V_1_0_5 = zext i8 %window_V_0_6_loc_1_l to i16
  ...
  %empty_8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_20)
  %tmp_38_0_5_cast = sext i16 %r_V_2_0_5 to i17
  %tmp_21 = call i32 (...)* @_ssdm_op_SpecRegionBegin([29 x i8]* @p_str4)
  %lhs_V_1_0_6 = zext i8 %window_V_0_6_loc_1_l_1 to i16
  ...
  %empty_9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_21)
  %tmp_38_0_6_cast = sext i16 %r_V_2_0_6 to i18
  ...
  %empty_10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_22)
  %tmp_38_1_cast = sext i16 %r_V_2_1 to i17
  ...
  %empty_11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_23)
  %tmp_38_1_1_cast = sext i16 %r_V_2_1_1 to i17
  ...
  %empty_12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_24)
  %tmp_38_1_2_cast = sext i16 %r_V_2_1_2 to i18
  ...
  %empty_13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_25)
  %tmp_38_1_3_cast = sext i16 %r_V_2_1_3 to i17
  ...
  %empty_14 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_26)
  %tmp_38_1_4_cast = sext i16 %r_V_2_1_4 to i17
  %tmp_27 = call i32 (...)* @_ssdm_op_SpecRegionBegin([29 x i8]* @p_str4)
  %lhs_V_1_1_5 = zext i8 %window_V_1_6_loc_1_l to i16
  ...
  %empty_15 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_27)
  %tmp_38_1_5_cast = sext i16 %r_V_2_1_5 to i18
  %tmp_28 = call i32 (...)* @_ssdm_op_SpecRegionBegin([29 x i8]* @p_str4)
  %lhs_V_1_1_6 = zext i8 %window_V_1_6_loc_1_l_1 to i16
  ...
  %empty_16 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_28)
  %tmp_38_1_6_cast = sext i16 %r_V_2_1_6 to i17
  ...
  %empty_17 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_29)
  %tmp_38_2_cast = sext i16 %r_V_2_2 to i17
  ...
  %empty_18 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_30)
  %tmp_38_2_1_cast = sext i16 %r_V_2_2_1 to i18
  ...
  %empty_19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_31)
  %tmp_38_2_2_cast = sext i16 %r_V_2_2_2 to i17
  ...
  %empty_20 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_32)
  %tmp_38_2_3_cast = sext i16 %r_V_2_2_3 to i17
  ...
  %tmp_38_2_4_cast = sext i16 %r_V_2_2_4 to i18
  %tmp_34 = call i32 (...)* @_ssdm_op_SpecRegionBegin([29 x i8]* @p_str4)
  %lhs_V_1_2_5 = zext i8 %window_V_2_6_loc_1_l to i16
  ...
  %tmp_38_2_5_cast = sext i16 %r_V_2_2_5 to i17
  %tmp_35 = call i32 (...)* @_ssdm_op_SpecRegionBegin([29 x i8]* @p_str4)
  %lhs_V_1_2_6 = zext i8 %window_V_2_6_loc_1_l_1 to i16
  ...
  %tmp_38_2_6_cast = sext i16 %r_V_2_2_6 to i17
  ...
  %empty_24 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_37)
  %tmp_38_3_cast = sext i16 %r_V_2_3 to i18
  ...
  %empty_25 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_38)
  %tmp_38_3_1_cast = sext i16 %r_V_2_3_1 to i17
  ...
  %empty_26 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_39)
  %tmp_38_3_2_cast = sext i16 %r_V_2_3_2 to i17
  ...
  %empty_27 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_40)
  %tmp_38_3_3_cast = sext i16 %r_V_2_3_3 to i18
  ...
  %empty_28 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_41)
  %tmp_38_3_4_cast = sext i16 %r_V_2_3_4 to i17
  %tmp_42 = call i32 (...)* @_ssdm_op_SpecRegionBegin([29 x i8]* @p_str4)
  %lhs_V_1_3_5 = zext i8 %window_V_3_6_loc_1_l to i16
  ...
  %empty_29 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_42)
  %tmp_38_3_5_cast = sext i16 %r_V_2_3_5 to i17
  %tmp_43 = call i32 (...)* @_ssdm_op_SpecRegionBegin([29 x i8]* @p_str4)
  %lhs_V_1_3_6 = zext i8 %window_V_3_6_loc_1_l_1 to i16
  ...
  %empty_30 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_43)
  %tmp_38_3_6_cast = sext i16 %r_V_2_3_6 to i18
  ...
  %empty_31 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_44)
  %tmp_38_4_cast = sext i16 %r_V_2_4 to i17
  ...
  %empty_32 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_45)
  %tmp_38_4_1_cast = sext i16 %r_V_2_4_1 to i17
  ...
  %empty_33 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_46)
  %tmp_38_4_2_cast = sext i16 %r_V_2_4_2 to i18
  ...
  %empty_34 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_47)
  %tmp_38_4_3_cast = sext i16 %r_V_2_4_3 to i17
  ...
  %empty_35 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_48)
  %tmp_38_4_4_cast = sext i16 %r_V_2_4_4 to i17
  %tmp_49 = call i32 (...)* @_ssdm_op_SpecRegionBegin([29 x i8]* @p_str4)
  %lhs_V_1_4_5 = zext i8 %window_V_4_6_loc_1_l to i16
  ...
  %empty_36 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_49)
  %tmp_38_4_5_cast = sext i16 %r_V_2_4_5 to i18
  %tmp_50 = call i32 (...)* @_ssdm_op_SpecRegionBegin([29 x i8]* @p_str4)
  %lhs_V_1_4_6 = zext i8 %window_V_4_6_loc_1_l_1 to i16
  ...
  %empty_37 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_50)
  %tmp_38_4_6_cast = sext i16 %r_V_2_4_6 to i17
  ...
  %empty_38 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_51)
  %tmp_38_5_cast = sext i16 %r_V_2_5 to i17
  ...
  %empty_39 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_52)
  %tmp_38_5_1_cast = sext i16 %r_V_2_5_1 to i18
  ...
  %empty_40 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_53)
  %tmp_38_5_2_cast = sext i16 %r_V_2_5_2 to i17
  ...
  %empty_41 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_54)
  %tmp_38_5_3_cast = sext i16 %r_V_2_5_3 to i17
  ...
  %empty_42 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_55)
  %tmp_38_5_4_cast = sext i16 %r_V_2_5_4 to i18
  %tmp_56 = call i32 (...)* @_ssdm_op_SpecRegionBegin([29 x i8]* @p_str4)
  %lhs_V_1_5_5 = zext i8 %window_V_5_6_loc_1_l to i16
  ...
  %empty_43 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_56)
  %tmp_38_5_5_cast = sext i16 %r_V_2_5_5 to i17
  %tmp_57 = call i32 (...)* @_ssdm_op_SpecRegionBegin([29 x i8]* @p_str4)
  %lhs_V_1_5_6 = zext i8 %window_V_5_6_loc_1_l_1 to i16
  ...
  %empty_44 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_57)
  %tmp_38_5_6_cast = sext i16 %r_V_2_5_6 to i17
  ...
  %empty_45 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_58)
  %tmp_38_6_cast = sext i16 %r_V_2_6 to i18
  ...
  %empty_46 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_59)
  %tmp_38_6_1_cast = sext i16 %r_V_2_6_1 to i17
  ...
  %empty_47 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_60)
  %tmp_38_6_2_cast = sext i16 %r_V_2_6_2 to i17
  ...
  %empty_48 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_61)
  %tmp_38_6_3_cast = sext i16 %r_V_2_6_3 to i17
  ...
  %empty_49 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_62)
  %tmp_38_6_4_cast = sext i16 %r_V_2_6_4 to i17
  ...
  %empty_50 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_63)
  %tmp_38_6_5_cast = sext i16 %r_V_2_6_5 to i17
  %tmp_64 = call i32 (...)* @_ssdm_op_SpecRegionBegin([29 x i8]* @p_str4)
  ...
  %empty_51 = call i32 (...)* @_ssdm_op_SpecRegionEnd([29 x i8]* @p_str4, i32 %tmp_64)
  %tmp_38_6_6_cast = sext i16 %r_V_2_6_6 to i17
  %tmp5 = add i17 %tmp_38_0_2_cast, %tmp_38_0_1_cast
  %tmp5_cast = sext i17 %tmp5 to i18
  %tmp4 = add i18 %tmp_381_cast, %tmp5_cast
  %tmp4_cast = sext i18 %tmp4 to i19
  %tmp7 = add i17 %tmp_38_0_5_cast, %tmp_38_0_4_cast
  %tmp7_cast = sext i17 %tmp7 to i18
  %tmp6 = add i18 %tmp_38_0_3_cast, %tmp7_cast
  %tmp6_cast = sext i18 %tmp6 to i19
  %tmp3 = add i19 %tmp4_cast, %tmp6_cast
  %tmp3_cast = sext i19 %tmp3 to i20
  %tmp = add i17 %tmp_38_1_1_cast, %tmp_38_1_cast
  %tmp10_cast = sext i17 %tmp to i18
  %tmp9 = add i18 %tmp_38_0_6_cast, %tmp10_cast
  %tmp9_cast = sext i18 %tmp9 to i19
  %tmp10 = add i17 %tmp_38_1_4_cast, %tmp_38_1_3_cast
  %tmp12_cast = sext i17 %tmp10 to i18
  %tmp11 = add i18 %tmp_38_1_2_cast, %tmp12_cast
  ...
  %tmp12 = add i17 %tmp_38_2_cast, %tmp_38_1_6_cast
  %tmp16_cast = sext i17 %tmp12 to i18
  %tmp15 = add i18 %tmp_38_1_5_cast, %tmp16_cast
  %tmp15_cast = sext i18 %tmp15 to i19
  %tmp16 = add i17 %tmp_38_2_3_cast, %tmp_38_2_2_cast
  %tmp18_cast = sext i17 %tmp16 to i18
  %tmp17 = add i18 %tmp_38_2_1_cast, %tmp18_cast
  %tmp17_cast = sext i18 %tmp17 to i19
  %tmp14 = add i19 %tmp15_cast, %tmp17_cast
  %tmp14_cast = sext i19 %tmp14 to i20
  %tmp18 = add i17 %tmp_38_2_6_cast, %tmp_38_2_5_cast
  %tmp21_cast = sext i17 %tmp18 to i18
  %tmp20 = add i18 %tmp_38_2_4_cast, %tmp21_cast
  %tmp20_cast = sext i18 %tmp20 to i19
  %tmp21 = add i17 %tmp_38_3_2_cast, %tmp_38_3_1_cast
  %tmp23_cast = sext i17 %tmp21 to i18
  %tmp22 = add i18 %tmp_38_3_cast, %tmp23_cast
  ...
  %tmp23 = add i17 %tmp_38_3_5_cast, %tmp_38_3_4_cast
  %tmp28_cast = sext i17 %tmp23 to i18
  %tmp27 = add i18 %tmp_38_3_3_cast, %tmp28_cast
  %tmp27_cast = sext i18 %tmp27 to i19
  %tmp28 = add i17 %tmp_38_4_1_cast, %tmp_38_4_cast
  %tmp30_cast = sext i17 %tmp28 to i18
  %tmp29 = add i18 %tmp_38_3_6_cast, %tmp30_cast
  %tmp29_cast = sext i18 %tmp29 to i19
  %tmp26 = add i19 %tmp27_cast, %tmp29_cast
  %tmp26_cast = sext i19 %tmp26 to i20
  %tmp30 = add i17 %tmp_38_4_4_cast, %tmp_38_4_3_cast
  %tmp33_cast = sext i17 %tmp30 to i18
  %tmp32 = add i18 %tmp_38_4_2_cast, %tmp33_cast
  %tmp32_cast = sext i18 %tmp32 to i19
  %tmp33 = add i17 %tmp_38_5_cast, %tmp_38_4_6_cast
  %tmp35_cast = sext i17 %tmp33 to i18
  %tmp34 = add i18 %tmp_38_4_5_cast, %tmp35_cast
  ...
  %tmp35 = add i17 %tmp_38_5_3_cast, %tmp_38_5_2_cast
  %tmp39_cast = sext i17 %tmp35 to i18
  %tmp38 = add i18 %tmp_38_5_1_cast, %tmp39_cast
  %tmp38_cast = sext i18 %tmp38 to i19
  %tmp39 = add i17 %tmp_38_5_6_cast, %tmp_38_5_5_cast
  %tmp41_cast = sext i17 %tmp39 to i18
  %tmp40 = add i18 %tmp_38_5_4_cast, %tmp41_cast
  %tmp40_cast = sext i18 %tmp40 to i19
  %tmp37 = add i19 %tmp38_cast, %tmp40_cast
  %tmp37_cast = sext i19 %tmp37 to i20
  %tmp41 = add i17 %tmp_38_6_2_cast, %tmp_38_6_1_cast
  %tmp44_cast = sext i17 %tmp41 to i18
  %tmp43 = add i18 %tmp_38_6_cast, %tmp44_cast
  %tmp43_cast = sext i18 %tmp43 to i19
  %tmp44 = add i17 %tmp_38_6_4_cast, %tmp_38_6_3_cast
  %tmp46_cast = sext i17 %tmp44 to i18
  %tmp46 = add i17 %tmp_38_6_6_cast, %tmp_38_6_5_cast
  %tmp47_cast = sext i17 %tmp46 to i18
  ...
  %tmp_28_tr = sext i22 %out_temp_V_6_6 to i23
  %tmp_29_tr = sext i8 %kernel_sum_V_load to i23
  %r_V = sdiv i23 %tmp_28_tr, %tmp_29_tr
  %tmp_67 = trunc i23 %r_V to i8
  %r_V_2 = add i8 %kernel_off_V_load, %tmp_67
...
._crit_edge66:                                    ; preds = %pixel_weighted_average.exit, %.loopexit._crit_edge
  %tmp_36 = add i19 %iteration_1_mid2, 1
  %empty_52 = call i32 (...)* @_ssdm_op_SpecRegionEnd([9 x i8]* @p_str11, i32 %tmp_1)
  %col_1 = add i10 %col_mid2, 1
  br label %0

.reset:                                           ; preds = %0
  call void (...)* @_ssdm_op_SpecLoopName([18 x i8]* @Loop_row_Loop_col_st)
  %tmp_4 = add i19 %iteration, 643
  %exitcond = icmp eq i10 %col, -381
  %iteration_1_mid2 = select i1 %exitcond, i19 %tmp_4, i19 %iteration_1
  %col_mid2 = select i1 %exitcond, i10 0, i10 %col
  %row_s = add i9 %row, 1
  %tmp_4_mid1 = icmp ult i9 %row_s, -32
  %tmp_5 = icmp ult i9 %row, -32
  %tmp_4_mid2 = select i1 %exitcond, i1 %tmp_4_mid1, i1 %tmp_5
  %tmp_6_mid1 = icmp ugt i9 %row_s, 2
  %tmp_6 = icmp ugt i9 %row, 2
  %tmp_6_mid2 = select i1 %exitcond, i1 %tmp_6_mid1, i1 %tmp_6
  %iteration_mid2 = select i1 %exitcond, i19 %tmp_4, i19 %iteration
  %row_mid2 = select i1 %exitcond, i9 %row_s, i9 %row
  call void (...)* @_ssdm_op_SpecLoopName([9 x i8]* @p_str11) nounwind
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([9 x i8]* @p_str11)
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str) nounwind
  %tmp_8 = icmp ult i19 %iteration_1_mid2, 49
  br i1 %tmp_8, label %._crit_edge63, label %1

; <label>:7                                       ; preds = %0
  ret void

branch0:                                          ; preds = %._crit_edge63
  switch i3 %tmp_66, label %branch13 [
    i3 0, label %branch7
    i3 1, label %branch8
    i3 2, label %branch9
    i3 3, label %branch10
...
branch1:                                          ; preds = %._crit_edge63
  switch i3 %tmp_66, label %branch20 [
    i3 0, label %branch14
    i3 1, label %branch15
    i3 2, label %branch16
    i3 3, label %branch17
...
branch2:                                          ; preds = %._crit_edge63
  switch i3 %tmp_66, label %branch27 [
    i3 0, label %branch21
    i3 1, label %branch22
    i3 2, label %branch23
    i3 3, label %branch24
...
branch3:                                          ; preds = %._crit_edge63
  switch i3 %tmp_66, label %branch34 [
    i3 0, label %branch28
    i3 1, label %branch29
    i3 2, label %branch30
    i3 3, label %branch31
...
branch4:                                          ; preds = %._crit_edge63
  switch i3 %tmp_66, label %branch41 [
    i3 0, label %branch35
    i3 1, label %branch36
    i3 2, label %branch37
    i3 3, label %branch38
...
branch5:                                          ; preds = %._crit_edge63
  switch i3 %tmp_66, label %branch48 [
    i3 0, label %branch42
    i3 1, label %branch43
    i3 2, label %branch44
    i3 3, label %branch45
...
branch6:                                          ; preds = %._crit_edge63
  switch i3 %tmp_66, label %branch55 [
    i3 0, label %branch49
    i3 1, label %branch50
    i3 2, label %branch51
    i3 3, label %branch52
...
!opencl.kernels = !{!0, !7, !13, !19, !21, !21, !24, !24, !24, !24, !24, !24, !24, !24, !30, !30, !30, !24, !24, !24, !24, !33, !39, !39, !43, !24, !24, !24, !46, !46, !49, !49, !51, !24, !24, !24, !49, !49, !24, !24, !53, !55, !57, !57, !59, !59, !57, !57, !24, !24, !61, !63, !24, !46, !46, !65, !65, !21, !21, !21, !21, !24, !24}
!hls.encrypted.func = !{}
!llvm.map.gv = !{!67}
...
!20 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int<8> &"}
...
!31 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_range_ref<24, true> &"}
...
!41 = metadata !{metadata !"kernel_arg_type", metadata !"ap_int_base<24, true>*", metadata !"int", metadata !"int"}
...
!44 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<23, true> &", metadata !"const ap_int_base<8, true> &"}
...
!50 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<23, true> &"}
!51 = metadata !{null, metadata !34, metadata !35, metadata !52, metadata !37, metadata !45, metadata !6}
!52 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<22, true> &", metadata !"const ap_int_base<8, true> &"}
!53 = metadata !{null, metadata !14, metadata !15, metadata !54, metadata !17, metadata !18, metadata !6}
!54 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int<22> &"}
!55 = metadata !{null, metadata !34, metadata !35, metadata !56, metadata !37, metadata !45, metadata !6}
!56 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<22, true> &", metadata !"const ap_int_base<16, true> &"}
!57 = metadata !{null, metadata !14, metadata !15, metadata !58, metadata !17, metadata !48, metadata !6}
!58 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<16, true> &"}
!59 = metadata !{null, metadata !14, metadata !15, metadata !60, metadata !17, metadata !48, metadata !6}
!60 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<22, true> &"}
!61 = metadata !{null, metadata !14, metadata !15, metadata !62, metadata !17, metadata !18, metadata !6}
!62 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int<16> &"}
!63 = metadata !{null, metadata !34, metadata !35, metadata !64, metadata !37, metadata !45, metadata !6}
!64 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<8, false> &", metadata !"const ap_int_base<8, true> &"}
!65 = metadata !{null, metadata !14, metadata !15, metadata !66, metadata !17, metadata !48, metadata !6}
!66 = metadata !{metadata !"kernel_arg_type", metadata !"const ap_int_base<8, false> &"}
...
!77 = metadata !{metadata !"kernel_config.V", metadata !78, metadata !"int8", i32 0, i32 7}
!78 = metadata !{metadata !79}
!79 = metadata !{i32 0, i32 50, i32 1}
!80 = metadata !{metadata !81}
!81 = metadata !{i32 0, i32 7, metadata !82}
!82 = metadata !{metadata !83}
!83 = metadata !{metadata !"in_img.V", metadata !84, metadata !"uint8", i32 0, i32 7}
!84 = metadata !{metadata !85}
!85 = metadata !{i32 0, i32 307199, i32 1}
!86 = metadata !{metadata !87}
!87 = metadata !{i32 0, i32 7, metadata !88}
!88 = metadata !{metadata !89}
!89 = metadata !{metadata !"out_img.V", metadata !84, metadata !"uint8", i32 0, i32 7}
