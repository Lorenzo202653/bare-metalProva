...
#ifndef __Filter_Convolutiosc4__HH__
#define __Filter_Convolutiosc4__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Filter_Convolutiosc4) {
    ...
    SC_CTOR(Filter_Convolutiosc4):  simcore_mac_3_U ("simcore_mac_3_U") {
