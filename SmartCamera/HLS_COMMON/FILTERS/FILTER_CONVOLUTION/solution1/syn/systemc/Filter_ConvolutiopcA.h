...
#ifndef __Filter_ConvolutiopcA__HH__
#define __Filter_ConvolutiopcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Filter_ConvolutiopcA) {
    ...
    SC_CTOR(Filter_ConvolutiopcA):  simcore_mac_0_U ("simcore_mac_0_U") {
