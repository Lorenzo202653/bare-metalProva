...
#ifndef __Filter_ConvolutioqcK__HH__
#define __Filter_ConvolutioqcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Filter_ConvolutioqcK) {
    ...
    SC_CTOR(Filter_ConvolutioqcK):  simcore_mac_1_U ("simcore_mac_1_U") {
