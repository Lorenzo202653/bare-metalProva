...
#ifndef __Filter_ConvolutiorcU__HH__
#define __Filter_ConvolutiorcU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Filter_ConvolutiorcU) {
    ...
    SC_CTOR(Filter_ConvolutiorcU):  simcore_mac_2_U ("simcore_mac_2_U") {
