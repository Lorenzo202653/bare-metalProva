...
#ifndef __sep_convolution_fkbM__HH__
#define __sep_convolution_fkbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sep_convolution_fkbM) {
    ...
    SC_CTOR(sep_convolution_fkbM):  simcore_mac_2_U ("simcore_mac_2_U") {
