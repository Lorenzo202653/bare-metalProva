...
#ifndef __sep_convolution_fjbC__HH__
#define __sep_convolution_fjbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sep_convolution_fjbC) {
    ...
    SC_CTOR(sep_convolution_fjbC):  simcore_mac_1_U ("simcore_mac_1_U") {
