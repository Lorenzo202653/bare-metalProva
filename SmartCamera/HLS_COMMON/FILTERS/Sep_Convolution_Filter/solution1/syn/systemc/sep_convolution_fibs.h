...
#ifndef __sep_convolution_fibs__HH__
#define __sep_convolution_fibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sep_convolution_fibs) {
    ...
    SC_CTOR(sep_convolution_fibs):  simcore_mac_0_U ("simcore_mac_0_U") {
