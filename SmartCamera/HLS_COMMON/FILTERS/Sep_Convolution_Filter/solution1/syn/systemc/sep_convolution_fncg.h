...
#ifndef __sep_convolution_fncg__HH__
#define __sep_convolution_fncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sep_convolution_fncg) {
    ...
    SC_CTOR(sep_convolution_fncg):  simcore_mac_4_U ("simcore_mac_4_U") {
