...
#ifndef __sep_convolution_fmb6__HH__
#define __sep_convolution_fmb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sep_convolution_fmb6) {
    ...
    SC_CTOR(sep_convolution_fmb6):  simcore_mac_3_U ("simcore_mac_3_U") {
