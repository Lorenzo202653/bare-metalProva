...
#ifndef __sep_convolution_flbW__HH__
#define __sep_convolution_flbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sep_convolution_flbW) {
    ...
    SC_CTOR(sep_convolution_flbW):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
