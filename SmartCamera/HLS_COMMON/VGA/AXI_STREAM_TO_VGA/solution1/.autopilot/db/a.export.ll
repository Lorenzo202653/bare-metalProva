; ModuleID = '/home/kidre/Documenti/Università/Uni/Tesi/SmartCamera/HLS_COMMON/VGA/AXI_STREAM_TO_VGA/solution1/.autopilot/db/a.o.2.bc'
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_V_1 = call i8 @_ssdm_op_Read.axis.volatile.i8P(i8* %inStream_V_V)
  %G_temp_V = call i4 @_ssdm_op_PartSelect.i4.i8.i32.i32(i8 %tmp_V_1, i32 4, i32 7)
  %tmp_V_2 = call i8 @_ssdm_op_Read.axis.volatile.i8P(i8* %inStream_V_V)
  %tmp_s = call i4 @_ssdm_op_PartSelect.i4.i8.i32.i32(i8 %tmp_V_2, i32 4, i32 7)
  store i4 %tmp_s, i4* %B_temp_V_read_assign
  store i4 %G_temp_V, i4* %G_temp_V_read_assign
  store i4 %R_temp_V, i4* %R_temp_V_read_assign
  br label %get_checkerboard_color.exit

; <label>:3                                       ; preds = %0
  %tmp_9 = call i1 @_ssdm_op_BitSelect.i1.i10.i32(i10 %y_coordinate_V_mid2, i32 5)
  %tmp_10 = call i1 @_ssdm_op_BitSelect.i1.i11.i32(i11 %p_Val2_s, i32 5)
  %tmp_1_i = zext i1 %tmp_10 to i19
  %tmp_2_i = call i21 @_ssdm_op_BitConcatenate.i21.i1.i19.i1(i1 false, i19 %tmp_1_i, i1 %tmp_9)
...
.preheader.preheader:                             ; preds = %.preheader
  %tmp_5 = icmp eq i10 %x, -224
  %x_mid2 = select i1 %tmp_5, i10 0, i10 %x
  %y_coordinate_V_mid2_s = select i1 %tmp_5, i10 -34, i10 -35
  %y_coordinate_V_mid2 = add i10 %y, %y_coordinate_V_mid2_s
  %y_s = add i10 %y, 1
  %tmp_8 = call i9 @_ssdm_op_PartSelect.i9.i10.i32.i32(i10 %y_s, i32 1, i32 9)
  %icmp1 = icmp ne i9 %tmp_8, 0
  %not_mid2 = select i1 %tmp_5, i1 %icmp1, i1 %icmp
  %tmp_2_mid1 = icmp ugt i10 %y_s, 34
  %tmp_3_mid1 = icmp ult i10 %y_s, -509
  %tmp2_mid1 = and i1 %tmp_2_mid1, %tmp_3_mid1
  %tmp2_mid2 = select i1 %tmp_5, i1 %tmp2_mid1, i1 %tmp2
  %y_mid2 = select i1 %tmp_5, i10 %y_s, i10 %y
