; ModuleID = '/home/kidre/Documenti/Università/Uni/Tesi/SmartCamera/HLS_COMMON/VGA/AXI_STREAM_TO_VGA/solution1/.autopilot/db/a.o.3.bc'
...
; <label>:2                                       ; preds = %1
  ...
  %R_temp_V = call i4 @_ssdm_op_PartSelect.i4.i8.i32.i32(i8 %tmp_V, i32 4, i32 7), !dbg !2277 ; [#uses=1 type=i4] [debug line = 229:89@229:104@115:16]
  ...
  %tmp_V_1 = call i8 @_ssdm_op_Read.axis.volatile.i8P(i8* %inStream_V_V), !dbg !2286 ; [#uses=1 type=i8] [debug line = 131:9@116:16]
  call void @llvm.dbg.value(metadata !{i8 %tmp_V_1}, i64 0, metadata !2275), !dbg !2286 ; [debug line = 131:9@116:16] [debug variable = tmp.V]
  %G_temp_V = call i4 @_ssdm_op_PartSelect.i4.i8.i32.i32(i8 %tmp_V_1, i32 4, i32 7), !dbg !2288 ; [#uses=1 type=i4] [debug line = 229:89@229:104@116:16]
  call void @llvm.dbg.value(metadata !{i4 %G_temp_V}, i64 0, metadata !2290), !dbg !2292 ; [debug line = 281:5@116:16] [debug variable = G_temp.V]
  %tmp_V_2 = call i8 @_ssdm_op_Read.axis.volatile.i8P(i8* %inStream_V_V), !dbg !2293 ; [#uses=1 type=i8] [debug line = 131:9@117:16]
  call void @llvm.dbg.value(metadata !{i8 %tmp_V_2}, i64 0, metadata !2275), !dbg !2293 ; [debug line = 131:9@117:16] [debug variable = tmp.V]
  %tmp_s = call i4 @_ssdm_op_PartSelect.i4.i8.i32.i32(i8 %tmp_V_2, i32 4, i32 7), !dbg !2295 ; [#uses=1 type=i4] [debug line = 229:89@229:104@117:16]
  store i4 %tmp_s, i4* %B_temp_V_read_assign
  store i4 %G_temp_V, i4* %G_temp_V_read_assign, !dbg !2292 ; [debug line = 281:5@116:16]
  store i4 %R_temp_V, i4* %R_temp_V_read_assign, !dbg !2284 ; [debug line = 281:5@115:16]
  br label %get_checkerboard_color.exit, !dbg !2297 ; [debug line = 118:5]

; <label>:3                                       ; preds = %0
  call void @llvm.dbg.value(metadata !{i11 %p_Val2_s}, i64 0, metadata !2298), !dbg !2303 ; [debug line = 1827:165@6:9@130:5] [debug variable = __Val2__]
  %tmp_9 = call i1 @_ssdm_op_BitSelect.i1.i10.i32(i10 %y_coordinate_V_mid2, i32 5), !dbg !2304 ; [#uses=1 type=i1] [debug line = 1827:167@6:32@130:5]
  ...
  %tmp_2_i = call i21 @_ssdm_op_BitConcatenate.i21.i1.i19.i1(i1 false, i19 %tmp_1_i, i1 %tmp_9) ; [#uses=1 type=i21]
  switch i21 %tmp_2_i, label %get_checkerboard_color.exit [
    i21 0, label %4
    i21 1, label %5
    i21 2, label %6
    i21 3, label %7
  ], !dbg !2305                                   ; [debug line = 6:32@130:5]

; <label>:4                                       ; preds = %3
  call void @llvm.dbg.value(metadata !{i4 %op2_V_read_assign}, i64 0, metadata !2306), !dbg !2310 ; [debug line = 280:84@9:10@130:5] [debug variable = op2.V]
  store i4 0, i4* %B_temp_V_read_assign
  store i4 0, i4* %G_temp_V_read_assign
  store i4 %op2_V_read_assign, i4* %R_temp_V_read_assign, !dbg !2310 ; [debug line = 280:84@9:10@130:5]
  br label %get_checkerboard_color.exit, !dbg !2311 ; [debug line = 12:13@130:5]

; <label>:5                                       ; preds = %3
  store i4 %tmp_6_i, i4* %B_temp_V_read_assign
  store i4 0, i4* %G_temp_V_read_assign
  store i4 0, i4* %R_temp_V_read_assign
  br label %get_checkerboard_color.exit, !dbg !2312 ; [debug line = 18:16@130:5]

; <label>:6                                       ; preds = %3
  store i4 %tmp_6_i, i4* %B_temp_V_read_assign
  store i4 0, i4* %G_temp_V_read_assign
  store i4 0, i4* %R_temp_V_read_assign
  br label %get_checkerboard_color.exit, !dbg !2313 ; [debug line = 24:13@130:5]

; <label>:7                                       ; preds = %3
  call void @llvm.dbg.value(metadata !{i4 %op2_V_read_assign}, i64 0, metadata !2314), !dbg !2315 ; [debug line = 280:84@27:13@130:5] [debug variable = op2.V]
  store i4 0, i4* %B_temp_V_read_assign
  store i4 0, i4* %G_temp_V_read_assign
  store i4 %op2_V_read_assign, i4* %R_temp_V_read_assign, !dbg !2315 ; [debug line = 280:84@27:13@130:5]
  br label %get_checkerboard_color.exit, !dbg !2316 ; [debug line = 30:16@130:5]

get_checkerboard_color.exit:                      ; preds = %7, %6, %5, %4, %3, %2, %.get_checkerboard_color.exit_crit_edge
  %R_temp_V_read_assign_1 = load i4* %R_temp_V_read_assign, !dbg !2317 ; [#uses=1 type=i4] [debug line = 268:5@135:4]
  %G_temp_V_read_assign_1 = load i4* %G_temp_V_read_assign, !dbg !2321 ; [#uses=1 type=i4] [debug line = 268:5@136:4]
  %B_temp_V_read_assign_1 = load i4* %B_temp_V_read_assign, !dbg !2323 ; [#uses=1 type=i4] [debug line = 268:5@137:4]
  call void @llvm.dbg.value(metadata !{i4* %R_V}, i64 0, metadata !2325), !dbg !2327 ; [debug line = 267:46@135:4] [debug variable = ssdm_int<4 + 1024 * 0, false>.V]
  call void @_ssdm_op_Write.ap_none.volatile.i4P(i4* %R_V, i4 %R_temp_V_read_assign_1), !dbg !2317 ; [debug line = 268:5@135:4]
  call void @llvm.dbg.value(metadata !{i4* %G_V}, i64 0, metadata !2325), !dbg !2328 ; [debug line = 267:46@136:4] [debug variable = ssdm_int<4 + 1024 * 0, false>.V]
  call void @_ssdm_op_Write.ap_none.volatile.i4P(i4* %G_V, i4 %G_temp_V_read_assign_1), !dbg !2321 ; [debug line = 268:5@136:4]
  call void @llvm.dbg.value(metadata !{i4* %B_V}, i64 0, metadata !2325), !dbg !2329 ; [debug line = 267:46@137:4] [debug variable = ssdm_int<4 + 1024 * 0, false>.V]
  call void @_ssdm_op_Write.ap_none.volatile.i4P(i4* %B_V, i4 %B_temp_V_read_assign_1), !dbg !2323 ; [debug line = 268:5@137:4]
  call void @llvm.dbg.value(metadata !{i1* %V_SYNC_V}, i64 0, metadata !2330), !dbg !2333 ; [debug line = 267:46@138:4] [debug variable = ssdm_int<1 + 1024 * 0, false>.V]
  call void @_ssdm_op_Write.ap_none.volatile.i1P(i1* %V_SYNC_V, i1 %not_mid2), !dbg !2335 ; [debug line = 268:5@138:4]
  call void @llvm.dbg.value(metadata !{i1* %H_SYNC_V}, i64 0, metadata !2330), !dbg !2337 ; [debug line = 267:46@139:4] [debug variable = ssdm_int<1 + 1024 * 0, false>.V]
  call void @_ssdm_op_Write.ap_none.volatile.i1P(i1* %H_SYNC_V, i1 %not_1), !dbg !2339 ; [debug line = 268:5@139:4]
  br label %9, !dbg !2340                         ; [debug line = 140:3]

; <label>:8                                       ; preds = %.preheader.preheader
  call void @llvm.dbg.value(metadata !{i4* %R_V}, i64 0, metadata !2325), !dbg !2341 ; [debug line = 267:46@143:4] [debug variable = ssdm_int<4 + 1024 * 0, false>.V]
  call void @_ssdm_op_Write.ap_none.volatile.i4P(i4* %R_V, i4 0), !dbg !2344 ; [debug line = 268:5@143:4]
  call void @llvm.dbg.value(metadata !{i4* %G_V}, i64 0, metadata !2325), !dbg !2345 ; [debug line = 267:46@144:4] [debug variable = ssdm_int<4 + 1024 * 0, false>.V]
  call void @_ssdm_op_Write.ap_none.volatile.i4P(i4* %G_V, i4 0), !dbg !2347 ; [debug line = 268:5@144:4]
  call void @llvm.dbg.value(metadata !{i4* %B_V}, i64 0, metadata !2325), !dbg !2348 ; [debug line = 267:46@145:4] [debug variable = ssdm_int<4 + 1024 * 0, false>.V]
  call void @_ssdm_op_Write.ap_none.volatile.i4P(i4* %B_V, i4 0), !dbg !2350 ; [debug line = 268:5@145:4]
  call void @llvm.dbg.value(metadata !{i1* %V_SYNC_V}, i64 0, metadata !2330), !dbg !2351 ; [debug line = 267:46@146:4] [debug variable = ssdm_int<1 + 1024 * 0, false>.V]
  call void @_ssdm_op_Write.ap_none.volatile.i1P(i1* %V_SYNC_V, i1 %not_mid2), !dbg !2353 ; [debug line = 268:5@146:4]
  call void @llvm.dbg.value(metadata !{i1* %H_SYNC_V}, i64 0, metadata !2330), !dbg !2354 ; [debug line = 267:46@147:4] [debug variable = ssdm_int<1 + 1024 * 0, false>.V]
  call void @_ssdm_op_Write.ap_none.volatile.i1P(i1* %H_SYNC_V, i1 %not_1), !dbg !2356 ; [debug line = 268:5@147:4]
  br label %9

; <label>:9                                       ; preds = %8, %get_checkerboard_color.exit
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str4, i32 %tmp_1), !dbg !2357 ; [#uses=0 type=i32] [debug line = 150:2]
  %x_1 = add i10 %x_mid2, 1, !dbg !2358           ; [#uses=1 type=i10] [debug line = 88:23]
  call void @llvm.dbg.value(metadata !{i10 %x_1}, i64 0, metadata !2359), !dbg !2358 ; [debug line = 88:23] [debug variable = x]
  br label %.preheader, !dbg !2358                ; [debug line = 88:23]

.preheader.preheader:                             ; preds = %.preheader
  %tmp_5 = icmp eq i10 %x, -224, !dbg !2360       ; [#uses=5 type=i1] [debug line = 88:7]
  %x_mid2 = select i1 %tmp_5, i10 0, i10 %x       ; [#uses=5 type=i10]
  %y_coordinate_V_mid2_s = select i1 %tmp_5, i10 -34, i10 -35, !dbg !2361 ; [#uses=1 type=i10] [debug line = 254:69@254:84@93:57]
  %y_coordinate_V_mid2 = add i10 %y, %y_coordinate_V_mid2_s, !dbg !2361 ; [#uses=1 type=i10] [debug line = 254:69@254:84@93:57]
  %y_s = add i10 %y, 1, !dbg !2367                ; [#uses=4 type=i10] [debug line = 87:23]
  %tmp_8 = call i9 @_ssdm_op_PartSelect.i9.i10.i32.i32(i10 %y_s, i32 1, i32 9), !dbg !2261 ; [#uses=1 type=i9] [debug line = 95:3]
  %icmp1 = icmp ne i9 %tmp_8, 0, !dbg !2261       ; [#uses=1 type=i1] [debug line = 95:3]
  %not_mid2 = select i1 %tmp_5, i1 %icmp1, i1 %icmp, !dbg !2261 ; [#uses=2 type=i1] [debug line = 95:3]
  ...
  %tmp2_mid2 = select i1 %tmp_5, i1 %tmp2_mid1, i1 %tmp2, !dbg !2262 ; [#uses=1 type=i1] [debug line = 101:3]
  %y_mid2 = select i1 %tmp_5, i10 %y_s, i10 %y    ; [#uses=1 type=i10]
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str4), !dbg !2368 ; [#uses=1 type=i32] [debug line = 89:3]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !2369 ; [debug line = 90:1]
  %tmp_5_cast = zext i10 %x_mid2 to i11, !dbg !2370 ; [#uses=1 type=i11] [debug line = 254:69@254:84@92:57]
  %p_Val2_s = add i11 %tmp_5_cast, -144, !dbg !2370 ; [#uses=1 type=i11] [debug line = 254:69@254:84@92:57]
  call void @llvm.dbg.value(metadata !{i11 %p_Val2_s}, i64 0, metadata !2373), !dbg !2370 ; [debug line = 254:69@254:84@92:57] [debug variable = x_coordinate.V]
  %not_1 = icmp ugt i10 %x_mid2, 95, !dbg !2381   ; [#uses=2 type=i1] [debug line = 98:3]
...
; <label>:10                                      ; preds = %.preheader
  ret void, !dbg !2382                            ; [debug line = 152:2]
}
...
!72 = metadata !{i32 786473, metadata !"/opt/Xilinx/Vivado/2018.1/common/technology/autopilot/ap_int.h", metadata !"/home/kidre/Documenti/Universit\C3\A0/Uni/Tesi/SmartCamera/HLS_COMMON/VGA", null} ; [ DW_TAG_file_type ]
...
!80 = metadata !{i32 786473, metadata !"/opt/Xilinx/Vivado/2018.1/common/technology/autopilot/ap_int_syn.h", metadata !"/home/kidre/Documenti/Universit\C3\A0/Uni/Tesi/SmartCamera/HLS_COMMON/VGA", null} ; [ DW_TAG_file_type ]
...
!84 = metadata !{i32 786473, metadata !"/opt/Xilinx/Vivado/2018.1/common/technology/autopilot/etc/autopilot_dt.def", metadata !"/home/kidre/Documenti/Universit\C3\A0/Uni/Tesi/SmartCamera/HLS_COMMON/VGA", null} ; [ DW_TAG_file_type ]
...
!1061 = metadata !{i32 786473, metadata !"AXI_STREAM_TO_VGA/vga_bram_read_address.cpp", metadata !"/home/kidre/Documenti/Universit\C3\A0/Uni/Tesi/SmartCamera/HLS_COMMON/VGA", null} ; [ DW_TAG_file_type ]
...
!1427 = metadata !{i32 786473, metadata !"/opt/Xilinx/Vivado/2018.1/common/technology/autopilot/hls_stream.h", metadata !"/home/kidre/Documenti/Universit\C3\A0/Uni/Tesi/SmartCamera/HLS_COMMON/VGA", null} ; [ DW_TAG_file_type ]
...
!2286 = metadata !{i32 131, i32 9, metadata !2274, metadata !2287}
!2287 = metadata !{i32 116, i32 16, metadata !2272, null}
!2288 = metadata !{i32 229, i32 89, metadata !2278, metadata !2289}
!2289 = metadata !{i32 229, i32 104, metadata !2281, metadata !2287}
!2290 = metadata !{i32 790529, metadata !2291, metadata !"G_temp.V", null, i32 107, metadata !1051, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2291 = metadata !{i32 786688, metadata !1416, metadata !"G_temp", metadata !1061, i32 107, metadata !76, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2292 = metadata !{i32 281, i32 5, metadata !2285, metadata !2287}
!2293 = metadata !{i32 131, i32 9, metadata !2274, metadata !2294}
!2294 = metadata !{i32 117, i32 16, metadata !2272, null}
!2295 = metadata !{i32 229, i32 89, metadata !2278, metadata !2296}
!2296 = metadata !{i32 229, i32 104, metadata !2281, metadata !2294}
!2297 = metadata !{i32 118, i32 5, metadata !2272, null}
!2298 = metadata !{i32 786688, metadata !2299, metadata !"__Val2__", metadata !80, i32 1827, metadata !1073, i32 0, metadata !2302} ; [ DW_TAG_auto_variable ]
!2299 = metadata !{i32 786443, metadata !2300, i32 1827, i32 19, metadata !80, i32 49} ; [ DW_TAG_lexical_block ]
!2300 = metadata !{i32 786443, metadata !2301, i32 1826, i32 68, metadata !80, i32 48} ; [ DW_TAG_lexical_block ]
!2301 = metadata !{i32 786478, i32 0, null, metadata !"get_bit", metadata !"get_bit", metadata !"_ZNK11ap_int_baseILi20ELb0ELb1EE7get_bitEi", metadata !80, i32 1826, metadata !1257, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1266, metadata !92, i32 1826} ; [ DW_TAG_subprogram ]
!2302 = metadata !{i32 6, i32 9, metadata !1059, metadata !1414}
!2303 = metadata !{i32 1827, i32 165, metadata !2299, metadata !2302}
!2304 = metadata !{i32 1827, i32 167, metadata !2299, metadata !2305}
!2305 = metadata !{i32 6, i32 32, metadata !1059, metadata !1414}
!2306 = metadata !{i32 790533, metadata !2307, metadata !"op2.V", null, i32 280, metadata !2308, i32 0, metadata !2309} ; [ DW_TAG_arg_variable_field_ro ]
!2307 = metadata !{i32 786689, metadata !71, metadata !"op2", metadata !72, i32 33554712, metadata !386, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2308 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !1051} ; [ DW_TAG_pointer_type ]
!2309 = metadata !{i32 9, i32 10, metadata !1058, metadata !1414}
!2310 = metadata !{i32 280, i32 84, metadata !71, metadata !2309}
!2311 = metadata !{i32 12, i32 13, metadata !1058, metadata !1414}
!2312 = metadata !{i32 18, i32 16, metadata !1058, metadata !1414}
!2313 = metadata !{i32 24, i32 13, metadata !1058, metadata !1414}
!2314 = metadata !{i32 790533, metadata !2307, metadata !"op2.V", null, i32 280, metadata !2308, i32 0, metadata !1057} ; [ DW_TAG_arg_variable_field_ro ]
!2315 = metadata !{i32 280, i32 84, metadata !71, metadata !1057}
!2316 = metadata !{i32 30, i32 16, metadata !1058, metadata !1414}
!2317 = metadata !{i32 268, i32 5, metadata !2318, metadata !2320}
!2318 = metadata !{i32 786443, metadata !2319, i32 267, i32 94, metadata !72, i32 11} ; [ DW_TAG_lexical_block ]
!2319 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZNV7ap_uintILi4EEaSERKS0_", metadata !72, i32 267, metadata !1036, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1035, metadata !92, i32 267} ; [ DW_TAG_subprogram ]
!2320 = metadata !{i32 135, i32 4, metadata !1416, null}
!2321 = metadata !{i32 268, i32 5, metadata !2318, metadata !2322}
!2322 = metadata !{i32 136, i32 4, metadata !1416, null}
!2323 = metadata !{i32 268, i32 5, metadata !2318, metadata !2324}
!2324 = metadata !{i32 137, i32 4, metadata !1416, null}
!2325 = metadata !{i32 790531, metadata !2326, metadata !"ssdm_int<4 + 1024 * 0, false>.V", null, i32 267, metadata !1050, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2326 = metadata !{i32 786689, metadata !2319, metadata !"this", metadata !72, i32 16777483, metadata !1808, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2327 = metadata !{i32 267, i32 46, metadata !2319, metadata !2320}
!2328 = metadata !{i32 267, i32 46, metadata !2319, metadata !2322}
!2329 = metadata !{i32 267, i32 46, metadata !2319, metadata !2324}
!2330 = metadata !{i32 790531, metadata !2331, metadata !"ssdm_int<1 + 1024 * 0, false>.V", null, i32 267, metadata !2213, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2331 = metadata !{i32 786689, metadata !2332, metadata !"this", metadata !72, i32 16777483, metadata !1809, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2332 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZNV7ap_uintILi1EEaSERKS0_", metadata !72, i32 267, metadata !2138, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2137, metadata !92, i32 267} ; [ DW_TAG_subprogram ]
!2333 = metadata !{i32 267, i32 46, metadata !2332, metadata !2334}
!2334 = metadata !{i32 138, i32 4, metadata !1416, null}
!2335 = metadata !{i32 268, i32 5, metadata !2336, metadata !2334}
!2336 = metadata !{i32 786443, metadata !2332, i32 267, i32 94, metadata !72, i32 10} ; [ DW_TAG_lexical_block ]
!2337 = metadata !{i32 267, i32 46, metadata !2332, metadata !2338}
!2338 = metadata !{i32 139, i32 4, metadata !1416, null}
!2339 = metadata !{i32 268, i32 5, metadata !2336, metadata !2338}
!2340 = metadata !{i32 140, i32 3, metadata !1416, null}
!2341 = metadata !{i32 267, i32 46, metadata !2319, metadata !2342}
!2342 = metadata !{i32 143, i32 4, metadata !2343, null}
!2343 = metadata !{i32 786443, metadata !1417, i32 142, i32 3, metadata !1061, i32 9} ; [ DW_TAG_lexical_block ]
!2344 = metadata !{i32 268, i32 5, metadata !2318, metadata !2342}
!2345 = metadata !{i32 267, i32 46, metadata !2319, metadata !2346}
!2346 = metadata !{i32 144, i32 4, metadata !2343, null}
!2347 = metadata !{i32 268, i32 5, metadata !2318, metadata !2346}
!2348 = metadata !{i32 267, i32 46, metadata !2319, metadata !2349}
!2349 = metadata !{i32 145, i32 4, metadata !2343, null}
!2350 = metadata !{i32 268, i32 5, metadata !2318, metadata !2349}
!2351 = metadata !{i32 267, i32 46, metadata !2332, metadata !2352}
!2352 = metadata !{i32 146, i32 4, metadata !2343, null}
!2353 = metadata !{i32 268, i32 5, metadata !2336, metadata !2352}
!2354 = metadata !{i32 267, i32 46, metadata !2332, metadata !2355}
!2355 = metadata !{i32 147, i32 4, metadata !2343, null}
!2356 = metadata !{i32 268, i32 5, metadata !2336, metadata !2355}
!2357 = metadata !{i32 150, i32 2, metadata !1417, null}
!2358 = metadata !{i32 88, i32 23, metadata !1418, null}
!2359 = metadata !{i32 786688, metadata !1420, metadata !"x", metadata !1061, i32 66, metadata !147, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2360 = metadata !{i32 88, i32 7, metadata !1418, null}
!2361 = metadata !{i32 254, i32 69, metadata !2362, metadata !2364}
!2362 = metadata !{i32 786443, metadata !2363, i32 254, i32 67, metadata !72, i32 27} ; [ DW_TAG_lexical_block ]
!2363 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi20EEC2Ej", metadata !72, i32 254, metadata !1368, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1367, metadata !92, i32 254} ; [ DW_TAG_subprogram ]
!2364 = metadata !{i32 254, i32 84, metadata !2365, metadata !2366}
!2365 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi20EEC1Ej", metadata !72, i32 254, metadata !1368, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1367, metadata !92, i32 254} ; [ DW_TAG_subprogram ]
!2366 = metadata !{i32 93, i32 57, metadata !1417, null}
!2367 = metadata !{i32 87, i32 23, metadata !1419, null}
!2368 = metadata !{i32 89, i32 3, metadata !1417, null}
!2369 = metadata !{i32 90, i32 1, metadata !1417, null}
!2370 = metadata !{i32 254, i32 69, metadata !2362, metadata !2371}
!2371 = metadata !{i32 254, i32 84, metadata !2365, metadata !2372}
!2372 = metadata !{i32 92, i32 57, metadata !1417, null}
!2373 = metadata !{i32 790529, metadata !2374, metadata !"x_coordinate.V", null, i32 92, metadata !2375, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2374 = metadata !{i32 786688, metadata !1417, metadata !"x_coordinate", metadata !1061, i32 92, metadata !1064, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2375 = metadata !{i32 786438, null, metadata !"ap_uint<20>", metadata !72, i32 183, i64 20, i64 32, i32 0, i32 0, null, metadata !2376, i32 0, null, metadata !1413} ; [ DW_TAG_class_field_type ]
!2376 = metadata !{metadata !2377}
!2377 = metadata !{i32 786438, null, metadata !"ap_int_base<20, false, true>", metadata !80, i32 1453, i64 20, i64 32, i32 0, i32 0, null, metadata !2378, i32 0, null, metadata !1329} ; [ DW_TAG_class_field_type ]
!2378 = metadata !{metadata !2379}
!2379 = metadata !{i32 786438, null, metadata !"ssdm_int<20 + 1024 * 0, false>", metadata !84, i32 22, i64 20, i64 32, i32 0, i32 0, null, metadata !2380, i32 0, null, metadata !1083} ; [ DW_TAG_class_field_type ]
!2380 = metadata !{metadata !1072}
!2381 = metadata !{i32 98, i32 3, metadata !1417, null}
!2382 = metadata !{i32 152, i32 2, metadata !1420, null}
