...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1260002", "EstimateLatencyMax" : "1260002",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"InDataflowNetwork" : "0",
...
set ArgLastReadFirstWriteLatency {
	axi_stream_to_vga {
		...
		inStream_V_V {Type I LastRead 3 FirstWrite -1}
		R_V {Type O LastRead -1 FirstWrite 4}
		G_V {Type O LastRead -1 FirstWrite 4}
		B_V {Type O LastRead -1 FirstWrite 4}
		V_SYNC_V {Type O LastRead -1 FirstWrite 1}
		H_SYNC_V {Type O LastRead -1 FirstWrite 3}
		color_blinking_V {Type IO LastRead -1 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1260002", "Max" : "1260002"}
	, {"Name" : "Interval", "Min" : "1260003", "Max" : "1260003"}
]}
