...
architecture behav of axis_to_ddr_writer is 
    ...
    "axis_to_ddr_writer,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu3eg-sbva484-1-e,HLS_INPUT_CLOCK=8.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.000000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=6,HLS_SYN_DSP=3,HLS_SYN_FF=1304,HLS_SYN_LUT=1746}";
    ...
    signal exitcond_flatten_reg_674 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal exitcond_reg_714 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond_reg_714_pp1_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal temp_reg_312 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_reg_324 : STD_LOGIC_VECTOR (3 downto 0);
    signal indvar_reg_335 : STD_LOGIC_VECTOR (9 downto 0);
    signal t_V_reg_638 : STD_LOGIC_VECTOR (7 downto 0);
    signal update_intr_read_read_fu_164_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal offset_fu_420_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_1_fu_444_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal j_mid2_fu_539_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal j_mid2_reg_688 : STD_LOGIC_VECTOR (9 downto 0);
    signal i_1_fu_553_p3 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_1_reg_694 : STD_LOGIC_VECTOR (3 downto 0);
    signal temp_2_fu_578_p3 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal offset_1_fu_624_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal offset_1_reg_733 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal i_op_assign_reg_251 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_op_assign_1_reg_260 : STD_LOGIC_VECTOR (28 downto 0);
    signal offset1_reg_269 : STD_LOGIC_VECTOR (31 downto 0);
    signal idx_reg_279 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_phi_mux_j_phi_fu_305_p4 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_phi_mux_i_phi_fu_328_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_10_fu_592_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ifzero_fu_587_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal indvar1_fu_619_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_9_fu_596_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_reg_ioackin_base_ddr_addr_AWREADY : STD_LOGIC := '0';
    signal ap_reg_ioackin_base_ddr_addr_WREADY : STD_LOGIC := '0';
    signal ap_block_pp1_stage0_01001 : BOOLEAN;
    signal p_tmp_7_fu_484_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_2_fu_502_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal frame_index_V_preg : STD_LOGIC_VECTOR (7 downto 0) := "00000000";
    signal r_V_fu_404_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal r_V_fu_404_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal r_V_fu_404_p2 : STD_LOGIC_VECTOR (34 downto 0);
    signal tmp_8_fu_410_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_op_assign_1_cast_fu_393_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_s_fu_430_p4 : STD_LOGIC_VECTOR (19 downto 0);
    signal tmp_3_fu_440_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_cast_fu_460_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_4_cast_fu_470_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal op2_assign_fu_464_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_5_fu_473_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_7_fu_479_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal j_s_fu_527_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal i_op_fu_547_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_11_fu_561_p4 : STD_LOGIC_VECTOR (55 downto 0);
    signal temp_1_fu_571_p3 : STD_LOGIC_VECTOR (55 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_idle_pp0 : STD_LOGIC;
    signal ap_enable_pp0 : STD_LOGIC;
    signal ap_idle_pp1 : STD_LOGIC;
    signal ap_enable_pp1 : STD_LOGIC;
    signal r_V_fu_404_p00 : STD_LOGIC_VECTOR (34 downto 0);
    signal r_V_fu_404_p10 : STD_LOGIC_VECTOR (34 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_const_logic_1 = ap_condition_pp0_exit_iter0_state4) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ap_enable_reg_pp0_iter0 <= ap_const_logic_0;
                elsif (((tmp_1_fu_444_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_const_logic_1 = ap_condition_pp1_exit_iter0_state7) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
                    ap_enable_reg_pp1_iter0 <= ap_const_logic_0;
                elsif (((ap_sig_ioackin_base_ddr_addr_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state6))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((exitcond_reg_714_pp1_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1))) then
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((tmp_1_fu_444_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    i_op_assign_1_reg_260_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                if ((update_intr_read_read_fu_164_p2 = ap_const_lv1_0)) then 
                    ...
                    i_op_assign_1_reg_260 <= base_address(31 downto 3);
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_1_fu_444_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                i_reg_324 <= ap_const_lv4_0;
            elsif (((exitcond_flatten_reg_674 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                i_reg_324 <= i_1_reg_694;
            end if; 
        end if;
    end process;

    idx_reg_279_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((base_ddr_addr_BVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((exitcond_flatten_fu_515_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                indvar_flatten_reg_290 <= indvar_flatten_next_fu_521_p2;
            end if; 
        end if;
    end process;

    indvar_reg_335_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_fu_607_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then 
    ...
    offset1_reg_269_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((base_ddr_addr_BVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14))) then 
    ...
    temp_reg_312_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_1_fu_444_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_reg_714 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_fu_515_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_flatten_fu_515_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_4_reg_683 <= tmp_4_fu_533_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state6, ap_enable_reg_pp1_iter2, ap_CS_fsm_state14, base_ddr_addr_BVALID, tmp_1_fu_444_p2, ap_CS_fsm_state3, exitcond_flatten_fu_515_p2, ap_enable_reg_pp0_iter0, ap_sig_ioackin_base_ddr_addr_AWREADY, exitcond_fu_607_p2, ap_enable_reg_pp1_iter0, ap_enable_reg_pp1_iter1, ap_block_pp0_stage0_subdone, ap_block_pp1_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if (not(((exitcond_flatten_fu_515_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif (((exitcond_flatten_fu_515_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state6;
                else
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                end if;
            when ap_ST_fsm_state6 => 
                if (((ap_sig_ioackin_base_ddr_addr_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state6))) then
                    ap_NS_fsm <= ap_ST_fsm_pp1_stage0;
                else
                    ap_NS_fsm <= ap_ST_fsm_state6;
                end if;
            when ap_ST_fsm_pp1_stage0 => 
                if ((not(((exitcond_fu_607_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter1 = ap_const_logic_0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) and not(((ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter1 = ap_const_logic_0) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp1_stage0;
                elsif ((((exitcond_fu_607_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter1 = ap_const_logic_0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1)) or ((ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter1 = ap_const_logic_0) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1)))) then
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(inputStream_V_0_vld_out, ap_enable_reg_pp0_iter1, exitcond_flatten_reg_674)
    begin
                ap_block_pp0_stage0_11001 <= ((exitcond_flatten_reg_674 = ap_const_lv1_0) and (inputStream_V_0_vld_out = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(inputStream_V_0_vld_out, ap_enable_reg_pp0_iter1, exitcond_flatten_reg_674)
    begin
                ap_block_pp0_stage0_subdone <= ((exitcond_flatten_reg_674 = ap_const_lv1_0) and (inputStream_V_0_vld_out = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;
    ...
    begin
                ap_block_pp1_stage0_11001 <= ((ap_const_boolean_1 = ap_block_state9_io) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1));
    end process;


    ap_block_pp1_stage0_subdone_assign_proc : process(ap_enable_reg_pp1_iter2, ap_block_state9_io)
    begin
                ap_block_pp1_stage0_subdone <= ((ap_const_boolean_1 = ap_block_state9_io) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1));
    end process;

        ap_block_state4_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state5_pp0_stage0_iter1_assign_proc : process(inputStream_V_0_vld_out, exitcond_flatten_reg_674)
    begin
                ap_block_state5_pp0_stage0_iter1 <= ((exitcond_flatten_reg_674 = ap_const_lv1_0) and (inputStream_V_0_vld_out = ap_const_logic_0));
    end process;

        ap_block_state7_pp1_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_state8_pp1_stage0_iter1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state9_io_assign_proc : process(exitcond_reg_714_pp1_iter1_reg, ap_sig_ioackin_base_ddr_addr_WREADY)
    begin
                ap_block_state9_io <= ((exitcond_reg_714_pp1_iter1_reg = ap_const_lv1_0) and (ap_sig_ioackin_base_ddr_addr_WREADY = ap_const_logic_0));
    end process;

        ap_block_state9_pp1_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_pp0_exit_iter0_state4_assign_proc : process(exitcond_flatten_fu_515_p2)
    begin
        if ((exitcond_flatten_fu_515_p2 = ap_const_lv1_1)) then 
    ...
    ap_condition_pp1_exit_iter0_state7_assign_proc : process(exitcond_fu_607_p2)
    begin
        if ((exitcond_fu_607_p2 = ap_const_lv1_1)) then 
    ...
    ap_done_assign_proc : process(tmp_1_fu_444_p2, ap_CS_fsm_state3)
    begin
        if (((tmp_1_fu_444_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    ap_phi_mux_i_phi_fu_328_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_flatten_reg_674, i_reg_324, i_1_reg_694)
    begin
        if (((exitcond_flatten_reg_674 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    ap_phi_mux_j_phi_fu_305_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_flatten_reg_674, j_reg_301, j_mid2_reg_688)
    begin
        if (((exitcond_flatten_reg_674 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    ap_ready_assign_proc : process(tmp_1_fu_444_p2, ap_CS_fsm_state3)
    begin
        if (((tmp_1_fu_444_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    base_ddr_addr_AWADDR <= tmp_9_fu_596_p1(32 - 1 downto 0);

    base_ddr_addr_AWVALID_assign_proc : process(ap_CS_fsm_state6, ap_reg_ioackin_base_ddr_addr_AWREADY)
    begin
        if (((ap_reg_ioackin_base_ddr_addr_AWREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state6))) then 
    ...
    base_ddr_addr_BREADY_assign_proc : process(ap_CS_fsm_state14, base_ddr_addr_BVALID)
    begin
        if (((base_ddr_addr_BVALID = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14))) then 
    ...
    base_ddr_addr_WVALID_assign_proc : process(ap_enable_reg_pp1_iter2, exitcond_reg_714_pp1_iter1_reg, ap_reg_ioackin_base_ddr_addr_WREADY, ap_block_pp1_stage0_01001)
    begin
        if (((exitcond_reg_714_pp1_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0_01001) and (ap_reg_ioackin_base_ddr_addr_WREADY = ap_const_logic_0) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1))) then 
    ...
    base_ddr_addr_blk_n_AW_assign_proc : process(m_axi_base_ddr_addr_AWREADY, ap_CS_fsm_state6)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state6)) then 
    ...
    base_ddr_addr_blk_n_B_assign_proc : process(m_axi_base_ddr_addr_BVALID, ap_CS_fsm_state14)
    begin
    ...
    base_ddr_addr_blk_n_W_assign_proc : process(m_axi_base_ddr_addr_WREADY, ap_enable_reg_pp1_iter2, ap_block_pp1_stage0, exitcond_reg_714_pp1_iter1_reg)
    begin
        if (((exitcond_reg_714_pp1_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0))) then 
    ...
    buffer_address0 <= indvar1_fu_619_p1(9 - 1 downto 0);
    buffer_address1 <= tmp_10_fu_592_p1(9 - 1 downto 0);
    ...
    buffer_d1 <= (inputStream_V_0_data_out & temp_1_fu_571_p3);

    buffer_we1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, ifzero_fu_587_p2)
    begin
        if (((ifzero_fu_587_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    exitcond_flatten_fu_515_p2 <= "1" when (indvar_flatten_reg_290 = ap_const_lv13_1000) else "0";
    exitcond_fu_607_p2 <= "1" when (indvar_reg_335 = ap_const_lv10_200) else "0";
    ...
    i_1_fu_553_p3 <= 
        ap_const_lv4_1 when (tmp_4_fu_533_p2(0) = '1') else 
        i_op_fu_547_p2;
    i_op_assign_1_cast_fu_393_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_op_assign_1_reg_260),32));
    i_op_fu_547_p2 <= std_logic_vector(unsigned(ap_phi_mux_i_phi_fu_328_p4) + unsigned(ap_const_lv4_1));
    idx_1_fu_450_p2 <= std_logic_vector(unsigned(idx_reg_279) + unsigned(ap_const_lv32_1));
    ifzero_fu_587_p2 <= "1" when (i_1_reg_694 = ap_const_lv4_8) else "0";
    indvar1_fu_619_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(indvar_reg_335),64));
    indvar_flatten_next_fu_521_p2 <= std_logic_vector(unsigned(indvar_flatten_reg_290) + unsigned(ap_const_lv13_1));
    indvar_next_fu_613_p2 <= std_logic_vector(unsigned(indvar_reg_335) + unsigned(ap_const_lv10_1));
    inputStream_V_0_ack_in <= inputStream_V_0_state(1);

    inputStream_V_0_ack_out_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond_flatten_reg_674, ap_block_pp0_stage0_11001)
    begin
        if (((exitcond_flatten_reg_674 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    inputStream_V_TDATA_blk_n_assign_proc : process(inputStream_V_0_state, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_flatten_reg_674)
    begin
        if (((exitcond_flatten_reg_674 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    j_mid2_fu_539_p3 <= 
        j_s_fu_527_p2 when (tmp_4_fu_533_p2(0) = '1') else 
        ap_phi_mux_j_phi_fu_305_p4;
    j_s_fu_527_p2 <= std_logic_vector(unsigned(ap_phi_mux_j_phi_fu_305_p4) + unsigned(ap_const_lv10_1));
    offset_1_fu_624_p2 <= std_logic_vector(signed(offset1_reg_269) + signed(ap_const_lv32_200));
    offset_fu_420_p2 <= std_logic_vector(unsigned(tmp_8_fu_410_p4) + unsigned(i_op_assign_1_cast_fu_393_p1));
    op2_assign_fu_464_p2 <= std_logic_vector(unsigned(tmp_2_cast_fu_460_p1) + unsigned(ap_const_lv9_1FF));
    p_tmp_7_fu_484_p3 <= 
        ap_const_lv8_0 when (tmp_5_fu_473_p2(0) = '1') else 
        tmp_7_fu_479_p2;
    r_V_fu_404_p0 <= r_V_fu_404_p00(32 - 1 downto 0);
    r_V_fu_404_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_op_assign_reg_251),35));
    r_V_fu_404_p1 <= r_V_fu_404_p10(8 - 1 downto 0);
    r_V_fu_404_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t_V_reg_638),35));
    r_V_fu_404_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(r_V_fu_404_p0) * unsigned(r_V_fu_404_p1), 35));
    temp_1_fu_571_p3 <= 
        ap_const_lv56_0 when (tmp_4_reg_683(0) = '1') else 
        tmp_11_fu_561_p4;
    temp_2_fu_578_p3 <= (inputStream_V_0_data_out & temp_1_fu_571_p3);
    tmp_10_fu_592_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_mid2_reg_688),64));
    tmp_11_fu_561_p4 <= temp_reg_312(63 downto 8);
    tmp_1_fu_444_p2 <= "1" when (unsigned(idx_reg_279) < unsigned(tmp_3_fu_440_p1)) else "0";
    tmp_2_cast_fu_460_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(FRAME_BUFFER_NUMBER_r),9));
    tmp_2_fu_502_p2 <= std_logic_vector(unsigned(frame_count_inner) + unsigned(ap_const_lv32_1));
    tmp_3_fu_440_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_s_fu_430_p4),32));
    tmp_4_cast_fu_470_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t_V_reg_638),9));
    tmp_4_fu_533_p2 <= "1" when (ap_phi_mux_i_phi_fu_328_p4 = ap_const_lv4_8) else "0";
    tmp_5_fu_473_p2 <= "1" when (tmp_4_cast_fu_470_p1 = op2_assign_fu_464_p2) else "0";
    tmp_7_fu_479_p2 <= std_logic_vector(unsigned(t_V_reg_638) + unsigned(ap_const_lv8_1));
    tmp_8_fu_410_p4 <= r_V_fu_404_p2(34 downto 3);
        tmp_9_fu_596_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(offset1_reg_269),64));

    tmp_s_fu_430_p4 <= FRAME_BUFFER_DIM_r(31 downto 12);
