...
proc create_hier_cell_VDMA { parentCell nameHier } {
  ...
  connect_bd_net -net axis_to_ddr_writer_CHROMA_frame_index_V [get_bd_pins frame_index_V] [get_bd_pins axis_to_ddr_writer_CHROMA/frame_index_V] [get_bd_pins ddr_to_axis_reader_0/frame_index_V]
