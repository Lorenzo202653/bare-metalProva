...
// Date        : Fri Sep  4 11:05:54 2020
// Host        : kidre-N551JX running 64-bit Ubuntu 16.04.7 LTS
// Command     : write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ prova2_axi_write_prova_0_0_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s_axi_AXILiteS_AWADDR, 
  ...
  m_axi_frame_index_AWADDR, m_axi_frame_index_AWLEN, m_axi_frame_index_AWSIZE, 
  m_axi_frame_index_AWBURST, m_axi_frame_index_AWLOCK, m_axi_frame_index_AWREGION, 
  m_axi_frame_index_AWCACHE, m_axi_frame_index_AWPROT, m_axi_frame_index_AWQOS, 
  m_axi_frame_index_AWVALID, m_axi_frame_index_AWREADY, m_axi_frame_index_WDATA, 
  m_axi_frame_index_WSTRB, m_axi_frame_index_WLAST, m_axi_frame_index_WVALID, 
  m_axi_frame_index_WREADY, m_axi_frame_index_BRESP, m_axi_frame_index_BVALID, 
  m_axi_frame_index_BREADY, m_axi_frame_index_ARADDR, m_axi_frame_index_ARLEN, 
  m_axi_frame_index_ARSIZE, m_axi_frame_index_ARBURST, m_axi_frame_index_ARLOCK, 
  m_axi_frame_index_ARREGION, m_axi_frame_index_ARCACHE, m_axi_frame_index_ARPROT, 
  m_axi_frame_index_ARQOS, m_axi_frame_index_ARVALID, m_axi_frame_index_ARREADY, 
  m_axi_frame_index_RDATA, m_axi_frame_index_RRESP, m_axi_frame_index_RLAST, 
  m_axi_frame_index_RVALID, m_axi_frame_index_RREADY, frame_count)
