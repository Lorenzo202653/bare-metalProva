...
-- Date        : Fri Oct  9 15:23:40 2020
-- Host        : kidre-N551JX running 64-bit Ubuntu 16.04.7 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ memcp_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : memcp_clk_wiz_0_0
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_memcp_clk_wiz_0_0_clk_wiz is
  port (
    clk_out1 : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_memcp_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_memcp_clk_wiz_0_0_clk_wiz is
  signal clk_in1_memcp_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_memcp_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_buf_memcp_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_memcp_clk_wiz_0_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clkfbout_memcp_clk_wiz_0_0,
      O => clkfbout_buf_memcp_clk_wiz_0_0
    );
...
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out1_memcp_clk_wiz_0_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 92.375000,
      CLKFBOUT_PHASE => 0.000000,
      CLKFBOUT_USE_FINE_PS => "FALSE",
      CLKIN1_PERIOD => 10.000000,
      CLKIN2_PERIOD => 0.000000,
      CLKOUT0_DIVIDE_F => 92.375000,
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_memcp_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1
    );
