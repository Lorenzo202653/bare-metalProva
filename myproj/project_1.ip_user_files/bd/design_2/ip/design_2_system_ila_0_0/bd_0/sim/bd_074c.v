...
module bd_074c
   (clk,
    probe0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN design_2_zynq_ultra_ps_e_0_1_pl_clk0, FREQ_HZ 99999999, PHASE 0.000" *) input clk;
  input [0:0]probe0;
