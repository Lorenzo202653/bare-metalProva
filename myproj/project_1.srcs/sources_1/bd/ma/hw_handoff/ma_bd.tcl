...
################################################################
# This is a generated script based on design: ma
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: ov7670_diretto_0, and set properties
  set ov7670_diretto_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:ov7670_diretto:1.0 ov7670_diretto_0 ]
  ...
  connect_bd_intf_net -intf_net ov7670_diretto_0_data_out_V [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins ov7670_diretto_0/data_out_V]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins ov7670_diretto_0/s_axi_AXILiteS] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net clk_net [get_bd_ports PCLK] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins ov7670_diretto_0/ap_clk] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins reset_24M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports XCLK] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net data_in_V_1 [get_bd_ports data_in_V] [get_bd_pins ov7670_diretto_0/data_in]
  connect_bd_net -net ext_reset_in_1 [get_bd_ports OV7670_RESET] [get_bd_pins axi_gpio_pl_reset/gpio_io_o]
  connect_bd_net -net href_V_1 [get_bd_ports href_V] [get_bd_pins ov7670_diretto_0/href_V]
  connect_bd_net -net ov7670_diretto_0_frame_valid_V [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins ov7670_diretto_0/frame_valid_V]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins ov7670_diretto_0/ap_rst_n] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins reset_24M/peripheral_aresetn]
  ...
  connect_bd_net -net vsync_V_1 [get_bd_ports vsync_V] [get_bd_pins ov7670_diretto_0/vsync_V]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ov7670_diretto_0/s_axi_AXILiteS/Reg] SEG_ov7670_diretto_0_Reg
