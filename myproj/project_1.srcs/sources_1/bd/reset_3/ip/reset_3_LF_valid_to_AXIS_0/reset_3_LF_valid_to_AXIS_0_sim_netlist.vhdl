...
-- Command     : write_vhdl -force -mode funcsim -rename_top reset_3_LF_valid_to_AXIS_0 -prefix
--               reset_3_LF_valid_to_AXIS_0_ design_1_LF_valid_to_AXIS_0_sim_netlist.vhdl
...
entity reset_3_LF_valid_to_AXIS_0_LF_valid_to_AXIS is
  port (
    ap_clk : in STD_LOGIC;
  ...
  attribute ap_ST_fsm_state1 of reset_3_LF_valid_to_AXIS_0_LF_valid_to_AXIS : entity is "2'b01";
  attribute ap_ST_fsm_state2 : string;
  attribute ap_ST_fsm_state2 of reset_3_LF_valid_to_AXIS_0_LF_valid_to_AXIS : entity is "2'b10";
  attribute hls_module : string;
  attribute hls_module of reset_3_LF_valid_to_AXIS_0_LF_valid_to_AXIS : entity is "yes";
end reset_3_LF_valid_to_AXIS_0_LF_valid_to_AXIS;

architecture STRUCTURE of reset_3_LF_valid_to_AXIS_0_LF_valid_to_AXIS is
...
entity reset_3_LF_valid_to_AXIS_0 is
  ...
  attribute NotValidForBitStream of reset_3_LF_valid_to_AXIS_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of reset_3_LF_valid_to_AXIS_0 : entity is "design_1_LF_valid_to_AXIS_0,LF_valid_to_AXIS,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of reset_3_LF_valid_to_AXIS_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of reset_3_LF_valid_to_AXIS_0 : entity is "LF_valid_to_AXIS,Vivado 2018.1";
  attribute hls_module : string;
  attribute hls_module of reset_3_LF_valid_to_AXIS_0 : entity is "yes";
end reset_3_LF_valid_to_AXIS_0;

architecture STRUCTURE of reset_3_LF_valid_to_AXIS_0 is
  attribute ap_ST_fsm_state1 : string;
...
begin
inst: entity work.reset_3_LF_valid_to_AXIS_0_LF_valid_to_AXIS
     port map (
      ap_clk => ap_clk,
      ap_done => ap_done,
      ap_idle => ap_idle,
