...
################################################################
# This is a generated script based on design: memcp
#
...
proc create_root_design { parentCell } {
  ...
  set PLCK [ create_bd_port -dir I -type clk PLCK ]
  ...
  # Create instance: ov7670_memcpy_0, and set properties
  set ov7670_memcpy_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:ov7670_memcpy:1.0 ov7670_memcpy_0 ]
 ...
 ] [get_bd_intf_pins /ov7670_memcpy_0/s_axi_AXILiteS]
  ...
  connect_bd_intf_net -intf_net ov7670_memcpy_0_m_axi_gmem [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins ov7670_memcpy_0/m_axi_gmem]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins ov7670_memcpy_0/s_axi_AXILiteS] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net c_counter_binary_0_THRESH0 [get_bd_ports LED_FRAME_VALID] [get_bd_pins c_counter_binary_0/THRESH0]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports XCLK] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports PLCK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins ov7670_memcpy_0/ap_clk] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins reset_24M/slowest_sync_clk]
  connect_bd_net -net data_in_V_1 [get_bd_ports data_in_V] [get_bd_pins ov7670_memcpy_0/data_in]
  connect_bd_net -net ext_reset_in_1 [get_bd_ports OV7670_RESET] [get_bd_pins axi_gpio_pl_reset/gpio_io_o]
  connect_bd_net -net href_V_1 [get_bd_ports href_V] [get_bd_pins ov7670_memcpy_0/href_V]
  connect_bd_net -net ov7670_memcpy_0_frame_valid_V [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins ov7670_memcpy_0/frame_valid_V]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins ov7670_memcpy_0/ap_rst_n] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins reset_24M/peripheral_aresetn]
  ...
  connect_bd_net -net vsync_V_1 [get_bd_ports vsync_V] [get_bd_pins ov7670_memcpy_0/vsync_V]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_gpio_pl_reset/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins reset_24M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces ov7670_memcpy_0/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces ov7670_memcpy_0/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ov7670_memcpy_0/s_axi_AXILiteS/Reg] SEG_ov7670_memcpy_0_Reg
