...
################################################################
# This is a generated script based on design: prova_gr
#
...
proc create_hier_cell_VDMA { parentCell nameHier } {
  ...
  connect_bd_net -net CLOCK_100M_1 [get_bd_pins clk_vdma] [get_bd_pins axi_mem_intercon_writer/ACLK] [get_bd_pins axi_mem_intercon_writer/M00_ACLK] [get_bd_pins axi_mem_intercon_writer/S00_ACLK] [get_bd_pins axis_data_fifo_pipeline_to_writer/m_axis_aclk] [get_bd_pins axis_to_ddr_writer_0/ap_clk]
  connect_bd_net -net PCLK_1 [get_bd_pins clk_in] [get_bd_pins axis_data_fifo_pipeline_to_writer/s_axis_aclk]
  connect_bd_net -net aresetn_in_1 [get_bd_pins aresetn_in] [get_bd_pins axis_data_fifo_pipeline_to_writer/s_axis_aresetn]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins aresetn_vdma] [get_bd_pins axi_mem_intercon_writer/M00_ARESETN] [get_bd_pins axi_mem_intercon_writer/S00_ARESETN] [get_bd_pins axis_data_fifo_pipeline_to_writer/m_axis_aresetn] [get_bd_pins axis_to_ddr_writer_0/ap_rst_n]
...
proc create_hier_cell_OV7670_GRAYSCALE_TO_AXIS { parentCell nameHier } {
  ...
  # Create instance: ov7670_grayscale_0, and set properties
  set ov7670_grayscale_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:ov7670_grayscale:1.0 ov7670_grayscale_0 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net LF_valid_to_AXIS_outputStream_V_V [get_bd_intf_pins LF_valid_to_AXIS/outputStream_V_V] [get_bd_intf_pins ov7670_grayscale_0/inStream_V_V]
  connect_bd_intf_net -intf_net ov7670_grayscale_0_outStream_V_V [get_bd_intf_pins outStream_V_V] [get_bd_intf_pins ov7670_grayscale_0/outStream_V_V]

  # Create port connections
  connect_bd_net -net PCLK_1 [get_bd_pins ap_clk] [get_bd_pins LF_valid_to_AXIS/ap_clk] [get_bd_pins ov7670_grayscale_0/ap_clk] [get_bd_pins ov7670_interface_0/ap_clk]
  connect_bd_net -net ap_done [get_bd_pins ap_done1] [get_bd_pins LF_valid_to_AXIS/ap_done]
  connect_bd_net -net ap_start_1 [get_bd_pins ap_start] [get_bd_pins LF_valid_to_AXIS/ap_start] [get_bd_pins ov7670_grayscale_0/ap_start] [get_bd_pins ov7670_interface_0/ap_start]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ap_rst_n] [get_bd_pins LF_valid_to_AXIS/ap_rst_n] [get_bd_pins ov7670_grayscale_0/ap_rst_n]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_net [get_bd_ports PCLK] [get_bd_pins OV7670_GRAYSCALE_TO_AXIS/ap_clk] [get_bd_pins VDMA/clk_in] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins reset_24M/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins OV7670_GRAYSCALE_TO_AXIS/ap_rst_n] [get_bd_pins VDMA/aresetn_in] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins reset_24M/peripheral_aresetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins VDMA/clk_vdma] [get_bd_pins axi_gpio_frame_intr/s_axi_aclk] [get_bd_pins axi_gpio_pl_reset/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins reset_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
