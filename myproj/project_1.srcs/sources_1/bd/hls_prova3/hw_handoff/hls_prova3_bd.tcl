...
################################################################
# This is a generated script based on design: hls_prova3
#
...
proc create_hier_cell_VDMA { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins axi_mem_intercon_writer/S00_AXI] [get_bd_intf_pins axi_write_prova_0/m_axi_frame_index]
  ...
  connect_bd_intf_net -intf_net axi_write_prova_0_m_axi_base_ddr_addr [get_bd_intf_pins axi_mem_intercon_writer/S03_AXI] [get_bd_intf_pins axi_write_prova_0/m_axi_base_ddr_addr]
  ...
  connect_bd_net -net S03_ARESETN_1 [get_bd_pins S03_ARESETN] [get_bd_pins axi_mem_intercon_writer/S03_ARESETN] [get_bd_pins axi_write_prova_0/ap_rst_n]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins aresetn_vdma] [get_bd_pins axi_mem_intercon_reader/M00_ARESETN] [get_bd_pins axi_mem_intercon_reader/S00_ARESETN] [get_bd_pins axi_mem_intercon_writer/M00_ARESETN] [get_bd_pins axi_mem_intercon_writer/S00_ARESETN] [get_bd_pins axi_mem_intercon_writer/S01_ARESETN] [get_bd_pins axi_mem_intercon_writer/S02_ARESETN] [get_bd_pins axis_data_fifo_pipeline_to_writer/m_axis_aresetn] [get_bd_pins axis_data_fifo_raw_CHROMA/m_axis_aresetn] [get_bd_pins axis_data_fifo_raw_LUMA/m_axis_aresetn] [get_bd_pins axis_to_ddr_writer_CHROMA/ap_rst_n] [get_bd_pins axis_to_ddr_writer_LUMA/ap_rst_n] [get_bd_pins ddr_to_axis_reader_0/ap_rst_n]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net PCLK_1 [get_bd_ports PCLK] [get_bd_pins OV7670_GRAYSCALE_TO_AXIS/ap_clk] [get_bd_pins VDMA/clk_in] [get_bd_pins reset_24M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn1 [get_bd_pins VDMA/S03_ARESETN] [get_bd_pins axi_gpio_pl_reset/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs VDMA/axi_write_prova_0/s_axi_AXILiteS/Reg] SEG_axi_write_prova_0_Reg
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces VDMA/axi_write_prova_0/Data_m_axi_frame_index] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP1_DDR_LOW
  ...
  exclude_bd_addr_seg [get_bd_addr_segs VDMA/axi_write_prova_0/Data_m_axi_base_ddr_addr/SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces VDMA/axi_write_prova_0/Data_m_axi_frame_index] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs VDMA/axi_write_prova_0/Data_m_axi_frame_index/SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM]
