...
-- Command     : write_vhdl -force -mode funcsim -rename_top hls_prova3_clk_wiz_0_0 -prefix
--               hls_prova3_clk_wiz_0_0_ prova_gpio_clk_wiz_0_0_sim_netlist.vhdl
...
entity hls_prova3_clk_wiz_0_0_prova_gpio_clk_wiz_0_0_clk_wiz is
  port (
    clk_out1 : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end hls_prova3_clk_wiz_0_0_prova_gpio_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of hls_prova3_clk_wiz_0_0_prova_gpio_clk_wiz_0_0_clk_wiz is
  signal clk_in1_prova_gpio_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_prova_gpio_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_buf_prova_gpio_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_prova_gpio_clk_wiz_0_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clkfbout_prova_gpio_clk_wiz_0_0,
      O => clkfbout_buf_prova_gpio_clk_wiz_0_0
    );
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_prova_gpio_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC"
        ...
        port map (
      CE => '1',
      I => clk_out1_prova_gpio_clk_wiz_0_0,
      O => clk_out1
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity hls_prova3_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of hls_prova3_clk_wiz_0_0 : entity is true;
end hls_prova3_clk_wiz_0_0;

architecture STRUCTURE of hls_prova3_clk_wiz_0_0 is
begin
inst: entity work.hls_prova3_clk_wiz_0_0_prova_gpio_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1
    );
