...
-- Date        : Mon Jul  6 09:59:08 2020
-- Host        : kidre-N551JX running 64-bit Ubuntu 16.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /media/kidre/Dati/GIT_TEST/bare-metalProva/myproj/project_1.srcs/sources_1/bd/design_1/ip/design_1_LF_valid_to_AXIS_0/design_1_LF_valid_to_AXIS_0_sim_netlist.vhdl
...
entity design_1_LF_valid_to_AXIS_0_LF_valid_to_AXIS is
  port (
    ap_clk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of design_1_LF_valid_to_AXIS_0_LF_valid_to_AXIS : entity is "LF_valid_to_AXIS";
  attribute ap_ST_fsm_state1 : string;
  attribute ap_ST_fsm_state1 of design_1_LF_valid_to_AXIS_0_LF_valid_to_AXIS : entity is "2'b01";
  attribute ap_ST_fsm_state2 : string;
  attribute ap_ST_fsm_state2 of design_1_LF_valid_to_AXIS_0_LF_valid_to_AXIS : entity is "2'b10";
  attribute hls_module : string;
  attribute hls_module of design_1_LF_valid_to_AXIS_0_LF_valid_to_AXIS : entity is "yes";
end design_1_LF_valid_to_AXIS_0_LF_valid_to_AXIS;

architecture STRUCTURE of design_1_LF_valid_to_AXIS_0_LF_valid_to_AXIS is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_LF_valid_to_AXIS_0 is
  port (
    ap_clk : in STD_LOGIC;
    ap_rst_n : in STD_LOGIC;
    ap_start : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_LF_valid_to_AXIS_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_LF_valid_to_AXIS_0 : entity is "design_1_LF_valid_to_AXIS_0,LF_valid_to_AXIS,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_LF_valid_to_AXIS_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_LF_valid_to_AXIS_0 : entity is "LF_valid_to_AXIS,Vivado 2018.1";
  attribute hls_module : string;
  attribute hls_module of design_1_LF_valid_to_AXIS_0 : entity is "yes";
end design_1_LF_valid_to_AXIS_0;

architecture STRUCTURE of design_1_LF_valid_to_AXIS_0 is
  attribute ap_ST_fsm_state1 : string;
...
begin
inst: entity work.design_1_LF_valid_to_AXIS_0_LF_valid_to_AXIS
     port map (
      ap_clk => ap_clk,
      ap_done => ap_done,
      ap_idle => ap_idle,
