...
################################################################
# This is a generated script based on design: prova2
#
...
proc create_hier_cell_VDMA { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 s_axi_frame_index
  ...
  # Create instance: axi_write_prova_0, and set properties
  set axi_write_prova_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:axi_write_prova:1.0 axi_write_prova_0 ]
  ...
  connect_bd_intf_net -intf_net axi_write_prova_0_m_axi_base_ddr_addr [get_bd_intf_pins axi_mem_intercon_writer/S00_AXI] [get_bd_intf_pins axi_write_prova_0/m_axi_base_ddr_addr]
  connect_bd_intf_net -intf_net axi_write_prova_0_m_axi_frame_index [get_bd_intf_pins axi_mem_intercon_reader/S01_AXI] [get_bd_intf_pins axi_write_prova_0/m_axi_frame_index]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_pipeline_to_writer_M_AXIS [get_bd_intf_pins axi_write_prova_0/inputStream_V] [get_bd_intf_pins axis_data_fifo_pipeline_to_writer/M_AXIS]
  ...
  connect_bd_intf_net -intf_net s_axi_AXILiteS_1 [get_bd_intf_pins s_axi_AXILiteS] [get_bd_intf_pins axi_write_prova_0/s_axi_AXILiteS]
  ...
  connect_bd_net -net S01_ARESETN_1 [get_bd_pins S01_ARESETN] [get_bd_pins axi_mem_intercon_reader/S01_ARESETN]
  ...
  connect_bd_net -net axis_to_ddr_writer_0_frame_index_V [get_bd_pins frame_index_V] [get_bd_pins axis_to_ddr_writer_CHROMA/frame_index_V] [get_bd_pins ddr_to_axis_reader_0/frame_index_V]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins aresetn_vdma] [get_bd_pins axi_mem_intercon_reader/M00_ARESETN] [get_bd_pins axi_mem_intercon_reader/S00_ARESETN] [get_bd_pins axi_mem_intercon_writer/M00_ARESETN] [get_bd_pins axi_mem_intercon_writer/S00_ARESETN] [get_bd_pins axi_mem_intercon_writer/S01_ARESETN] [get_bd_pins axi_mem_intercon_writer/S02_ARESETN] [get_bd_pins axi_write_prova_0/ap_rst_n] [get_bd_pins axis_data_fifo_pipeline_to_writer/m_axis_aresetn] [get_bd_pins axis_data_fifo_raw_CHROMA/m_axis_aresetn] [get_bd_pins axis_data_fifo_raw_LUMA/m_axis_aresetn] [get_bd_pins axis_to_ddr_writer_CHROMA/ap_rst_n] [get_bd_pins axis_to_ddr_writer_LUMA/ap_rst_n] [get_bd_pins ddr_to_axis_reader_0/ap_rst_n]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net OV7670_GRAYSCALE_TO_AXIS_outStream_V_V1 [get_bd_intf_pins OV7670_GRAYSCALE_TO_AXIS/outStream_V_V] [get_bd_intf_pins VDMA/AXIS_IN]
  connect_bd_intf_net -intf_net OV7670_GRAYSCALE_TO_AXIS_outStream_raw_CHROMA1 [get_bd_intf_pins OV7670_GRAYSCALE_TO_AXIS/outStream_raw_CHROMA] [get_bd_intf_pins VDMA/AXIS_IN_RAW_CHROMA]
  connect_bd_intf_net -intf_net OV7670_GRAYSCALE_TO_AXIS_outStream_raw_LUMA1 [get_bd_intf_pins OV7670_GRAYSCALE_TO_AXIS/outStream_raw_LUMA] [get_bd_intf_pins VDMA/AXIS_IN_RAW_LUMA]
  connect_bd_intf_net -intf_net S00_AXI_4 [get_bd_intf_pins processing_system7_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M06_AXI [get_bd_intf_pins VDMA/s_axi_frame_index] [get_bd_intf_pins processing_system7_0_axi_periph/M06_AXI]

  # Create port connections
  connect_bd_net -net ENABLE_RAW_STREAM_dout1 [get_bd_pins ENABLE_RAW_STREAM/dout] [get_bd_pins OV7670_GRAYSCALE_TO_AXIS/enable_raw_stream]
  connect_bd_net -net OV7670_GRAYSCALE_TO_AXIS_Q1 [get_bd_ports LED_FRAME_VALID] [get_bd_pins OV7670_GRAYSCALE_TO_AXIS/LED_FRAME_VALID]
  connect_bd_net -net PCLK_2 [get_bd_ports PCLK] [get_bd_pins OV7670_GRAYSCALE_TO_AXIS/ap_clk] [get_bd_pins VDMA/clk_in] [get_bd_pins reset_24M/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn1 [get_bd_pins VDMA/S01_ARESETN] [get_bd_pins axi_gpio_pl_reset/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins VDMA/clk_vdma] [get_bd_pins axi_gpio_frame_intr/s_axi_aclk] [get_bd_pins axi_gpio_pl_reset/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/M06_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins reset_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0050000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs VDMA/axi_write_prova_0/s_axi_AXILiteS/Reg] SEG_axi_write_prova_0_Reg
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces VDMA/axi_write_prova_0/Data_m_axi_frame_index] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces VDMA/axi_write_prova_0/Data_m_axi_base_ddr_addr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP1_DDR_LOW
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces VDMA/axi_write_prova_0/Data_m_axi_base_ddr_addr] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM
  ...
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces VDMA/axi_write_prova_0/Data_m_axi_frame_index] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs VDMA/axi_write_prova_0/Data_m_axi_frame_index/SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM]
