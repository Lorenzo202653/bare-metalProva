...
HD_PWD='/media/kidre/Dati/GIT_TEST/bare-metalProva/myproj/project_1.runs/pulsante_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pulsante_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pulsante_xbar_2.tcl
