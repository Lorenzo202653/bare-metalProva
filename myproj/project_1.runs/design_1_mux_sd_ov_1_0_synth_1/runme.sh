...
HD_PWD='/media/kidre/Dati/GIT_TEST/bare-metalProva/myproj/project_1.runs/design_1_mux_sd_ov_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mux_sd_ov_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mux_sd_ov_1_0.tcl
