...
HD_PWD='/media/kidre/Dati/GIT_TEST/bare-metalProva/myproj/project_1.runs/ma_ov7670_diretto_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ma_ov7670_diretto_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ma_ov7670_diretto_0_0.tcl
