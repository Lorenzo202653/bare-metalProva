...
HD_PWD='/media/kidre/Dati/GIT_TEST/bare-metalProva/myproj/project_1.runs/prova2_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prova2_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prova2_xbar_1.tcl
