...
HD_PWD='/media/kidre/Dati/GIT_TEST/bare-metalProva/myproj/project_1.runs/design_1_reset_25M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_reset_25M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_reset_25M_0.tcl
