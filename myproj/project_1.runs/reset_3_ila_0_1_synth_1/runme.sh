...
HD_PWD='/media/kidre/Dati/GIT_TEST/bare-metalProva/myproj/project_1.runs/reset_3_ila_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reset_3_ila_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reset_3_ila_0_1.tcl
