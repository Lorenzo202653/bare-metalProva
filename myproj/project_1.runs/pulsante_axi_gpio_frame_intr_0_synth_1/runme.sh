...
HD_PWD='/media/kidre/Dati/GIT_TEST/bare-metalProva/myproj/project_1.runs/pulsante_axi_gpio_frame_intr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pulsante_axi_gpio_frame_intr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pulsante_axi_gpio_frame_intr_0.tcl
