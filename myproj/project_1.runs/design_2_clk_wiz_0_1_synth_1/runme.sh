...
HD_PWD='/media/kidre/Dati/GIT_TEST/bare-metalProva/myproj/project_1.runs/design_2_clk_wiz_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_clk_wiz_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_clk_wiz_0_1.tcl
